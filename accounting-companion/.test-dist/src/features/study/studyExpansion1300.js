function makeTopic(seed) {
    return {
        ...
        formulaOverview: [
            {
                ...
                explanation: "Version 13.0.0 topics are written to connect reviewer content, quizzes, and calculator routes instead of standing alone.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            interpretation: "The learning value comes from the connection between classification, computation, and the follow-up route.",
        },
        checkpointExample: {
            ...
            interpretation: "A checkpoint prevents a small classification error from turning into a full wrong solution.",
        },
        interpretation: [
            ...
            [
                {
                    ...
                    summary: "Use this reviewer section to keep the conceptual step connected to the calculator step.",
                    points: [
        ...
        quiz: {
            ...
            intro: "A compact CPA-review style check linked to the lesson and the recommended AccCalc solving route.",
            questions: [
                seed.quizQuestion,
                {
                    id: `${seed.id}-tf-route`,
                    kind: "true-false",
                    prompt: "The best AccCalc route is the one that matches the controlling issue, not simply the first route with similar keywords.",
                    answer: true,
                    explanation: "Version 13.0.0 uses linked lessons and calculators to train route discipline in mixed cases.",
                },
                {
                    ...
                    explanation: "Naming the controlling issue prevents the rest of the solution from drifting into the wrong calculator or reviewer path.",
...
export const STUDY_HUB_EXPANSION_1300_TOPICS = [
    makeTopic({
        ...
        summary: "Review element classification, recognition support, measurement-basis selection, and disclosure judgment before FAR computation.",
        intro: "Conceptual framework questions often control the route for intermediate accounting. This module makes students decide whether the item is an asset, liability, income, expense, or disclosure issue before measuring it.",
        focus: "element classification, recognition support, and measurement basis",
        workedScenario: "A case asks whether a signed supply arrangement creates an asset, liability, expense, or disclosure-only matter before any amount is computed.",
        workedResult: "Use the Conceptual Framework Recognition Helper first, then route to the matching FAR measurement workspace only if recognition is supportable.",
        checkpointScenario: "A student records an asset because management expects future benefit, but the entity does not control the resource yet.",
        checkpointResult: "Control and past-event discipline should be checked before recognition.",
        ...
        quizQuestion: {
            ...
            answerIndex: 0,
            explanation: "Asset recognition starts with control of a present economic resource from a past event, then moves to measurement support.",
        },
    }),
    makeTopic({
        ...
        category: "Financial Accounting",
        summary: "Practice transaction-price allocation, performance-obligation satisfaction, and contract asset or liability interpretation.",
        intro: "Revenue questions become safer when students separate performance obligations, allocate using relative standalone selling prices, then compare recognized revenue with consideration received.",
        focus: "performance-obligation allocation and contract balance reading",
        workedScenario: "A bundled contract includes equipment and service support with separate standalone selling prices and different satisfaction progress.",
        workedResult: "Use the Revenue Allocation Workspace to allocate the transaction price, recognize revenue by satisfaction percentage, and identify a contract asset or liability.",
        checkpointScenario: "A student recognizes all cash received as revenue even though one service obligation is only partly satisfied.",
        checkpointResult: "Cash collection and revenue recognition must be separated.",
        ...
        quizQuestion: {
            ...
            answerIndex: 0,
            explanation: "Advance consideration often creates a contract liability for the unsatisfied performance obligation.",
        },
    }),
    makeTopic({
        ...
        category: "Taxation",
        summary: "Bridge accounting income to taxable income using permanent differences, temporary differences, loss deductions, current tax, and deferred-tax signals.",
        intro: "Income taxation problems require careful labeling. The bridge prevents students from mixing financial-reporting income, taxable income, and deferred-tax effects.",
        focus: "accounting income to taxable income reconciliation",
        workedScenario: "Accounting income includes nondeductible expense, nontaxable income, accelerated tax depreciation, and a deductible accrued expense reversing later.",
        workedResult: "Use the Taxable Income Bridge to separate permanent and temporary items before reading current tax and deferred-tax signals.",
        checkpointScenario: "A student treats every difference as temporary and creates deferred tax for a permanent nondeductible expense.",
        checkpointResult: "Permanent differences affect taxable income but do not reverse.",
        ...
        quizQuestion: {
            ...
            answerIndex: 0,
            explanation: "Permanent differences affect taxable income for the current computation but do not reverse in future periods.",
        },
    }),
    makeTopic({
        ...
        summary: "Connect market-driven price, required profit, allowable cost, cost gap, and follow-up cost-reduction actions.",
        intro: "Strategic cost management is not just cost-plus pricing. Target costing begins with the market and asks whether the product can be designed into an allowable cost.",
        focus: "target profit, allowable cost, and strategic cost gap",
        workedScenario: "A proposed product has a market price, required margin, expected volume, estimated design cost, and planned supplier savings.",
        workedResult: "Use the Target Costing Workspace to compute allowable cost and decide whether further design, process, or supplier work is needed.",
        checkpointScenario: "A student adds a markup to estimated cost even though the case gives a market ceiling price.",
        checkpointResult: "Target costing works backward from market price and target profit, not forward from current cost.",
        ...
        quizQuestion: {
            ...
            answerIndex: 0,
            explanation: "Target costing starts with the price customers are expected to accept and subtracts the required profit.",
        },
    }),
    makeTopic({
        ...
        summary: "Review assertion risk, evidence reliability, relevance, coverage, contradictions, and audit-procedure intensity.",
        intro: "Audit evidence questions are stronger when students connect assertions to procedure design and explain why contradictory evidence changes the response.",
        focus: "assertion risk and sufficient appropriate evidence",
        workedScenario: "Inventory valuation has high assertion risk, internally generated reports, limited test coverage, and one contradiction from supplier confirmation.",
        workedResult: "Use the Audit Evidence Program Builder to identify the residual evidence gap and plan stronger procedures.",
        checkpointScenario: "A student says evidence is enough because several documents exist, even though they are weakly relevant and contradictory.",
        checkpointResult: "Quantity of documents does not replace relevance, reliability, and contradiction resolution.",
        ...
        quizQuestion: {
            ...
            answerIndex: 0,
            explanation: "Contradictory evidence affects sufficiency and appropriateness; the auditor needs follow-up before concluding.",
        },
    }),
    makeTopic({
        ...
        category: "Strategic / Integrative",
        summary: "Map practical financial accounting cases into conceptual framework, FAR measurement, tax, audit, and workpaper follow-up routes.",
        intro: "Practical financial accounting review often mixes recognition, measurement, tax effects, and audit evidence. This topic trains students to route the case rather than treating it as one flat computation.",
        focus: "integrated practical financial accounting route selection",
        workedScenario: "A review case combines revenue allocation, receivable collectability, income-tax difference, and audit evidence around the same customer contract.",
        workedResult: "Map the case first, solve revenue allocation, review allowance or tax bridge only if facts require it, then use audit evidence support for the assurance angle.",
        checkpointScenario: "A student solves a revenue number but ignores the audit evidence and tax difference asked in the final requirement.",
        checkpointResult: "Integrated cases need a route map before individual computations.",
        ...
        quizQuestion: {
            ...
            answerIndex: 0,
            explanation: "Mixed CPA-style cases reward route mapping because the requirements may cross FAR, tax, audit, and reviewer topics.",
        },
    }),
];
