function makeFinalTopic(seed) {
    return {
        ...
        formulaOverview: [
            {
                ...
                explanation: "This final expansion topic is built to move from lesson reading into a practice check and then into the linked workspace.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            interpretation: "A strong answer explains why the route fits, not only what the final number or label says.",
        },
        checkpointExample: {
            ...
            interpretation: "The checkpoint is meant to prevent a familiar keyword from sending the student to a weaker route.",
        },
        interpretation: [
        ...
        deepDiveSections: [
            {
                ...
                summary: "This bridge keeps conceptual review, practice, and solving connected in one topic family.",
                points: [
            ...
            },
            {
                ...
                summary: "When the first answer is wrong, repair the route choice before repeating the calculation.",
                points: [
        ...
        quiz: {
            ...
            intro: "A compact, original practice set that checks classification, response choice, and the linked solving route.",
            questions: seed.quiz,
        },
    };
}
export const STUDY_HUB_EXPANSION_1310_TOPICS = [
    makeFinalTopic({
        ...
        summary: "Review planning materiality, performance materiality, clearly trivial thresholds, and aggregate misstatement pressure.",
        intro: "Audit materiality questions are strongest when students separate the planning threshold, the performance threshold, and the completion-stage response to uncorrected misstatements.",
        ...
        workedScenario: "Profit before tax is used as a benchmark. Expected misstatement plus known uncorrected items now approaches performance materiality.",
        workedResult: "Use the materiality planner, compare aggregate pressure with performance materiality, and expand follow-up when the cushion is thin or negative.",
        checkpointScenario: "A student compares misstatements only with planning materiality and ignores performance materiality.",
        checkpointResult: "Performance materiality is the tighter classroom threshold for reducing aggregation risk.",
        quiz: [
            {
                ...
                answerIndex: 0,
                explanation: "Performance materiality is set below overall materiality to reduce the risk that aggregate misstatements exceed the overall threshold.",
            },
            {
                ...
                answer: true,
                explanation: "Clearly trivial is not a license to ignore qualitative patterns, fraud indicators, or control implications.",
            },
            {
                ...
                explanation: "The review looks at aggregate expected and identified misstatement pressure, not each item in isolation.",
            },
            {
                ...
                answerIndex: 0,
                explanation: "The materiality planner is designed for planning thresholds, clearly trivial amounts, and misstatement cushion.",
            },
        ],
    }),
    makeFinalTopic({
        ...
        category: "Taxation",
        summary: "Bridge taxable income into gross tax due, credit application, final payable, or overpayment review.",
        intro: "Income-tax review does not stop at taxable income. Students also need to reconcile credits, payments, refundable items, and penalties before reading the final position.",
        ...
        workedScenario: "A taxpayer has taxable income, withholding credits, quarterly tax payments, and a small penalty after the deadline.",
        workedResult: "Compute gross tax due, subtract credits and payments, add penalties, then classify the remaining amount as payable or overpayment.",
        checkpointScenario: "A student reports gross tax due as final tax payable even though withholding credits are provided.",
        checkpointResult: "Credits and payments must be applied before the final payable or overpayment is read.",
        quiz: [
            {
                ...
                answerIndex: 0,
                explanation: "Withholding credits and payments reduce gross tax due before the final payable or overpayment is read.",
            },
            {
                ...
                answer: true,
                explanation: "Overpayment classification depends on the applicable tax rules and facts.",
            },
            {
                ...
                explanation: "The workspace starts with gross tax due, then applies credits, payments, and penalties.",
            },
            {
                ...
                answerIndex: 0,
                explanation: "Those facts point to payable or overpayment reconciliation, not a general tax bridge only.",
            },
        ],
    }),
    makeFinalTopic({
        ...
        summary: "Map order-to-cash controls to occurrence, completeness, cutoff, accuracy, collectability, and monitoring concerns.",
        intro: "Revenue-cycle AIS questions become easier when students connect each control to the assertion or data-integrity risk it is meant to address.",
        ...
        workedScenario: "Sales orders are approved, but credit-limit checks are manual and exception reports are not consistently reviewed.",
        workedResult: "Use the revenue-cycle review route to identify collectability and monitoring gaps before deciding whether reliance is supportable.",
        checkpointScenario: "A student treats all revenue controls as occurrence controls.",
        checkpointResult: "Different controls support different assertions such as occurrence, completeness, cutoff, and accuracy.",
        quiz: [
            {
                ...
                answerIndex: 0,
                explanation: "Sequence gaps can indicate missing invoices or cutoff problems in the revenue cycle.",
            },
            {
                ...
                answer: true,
                explanation: "Design alone is not enough; the reviewer needs evidence that the control is implemented and operating.",
            },
            {
                ...
                explanation: "The revenue or sales cycle covers order approval, shipment, invoicing, receivables, and cash application.",
            },
            {
                ...
                answerIndex: 0,
                explanation: "The Revenue Cycle Control Review is the dedicated AIS route for order-to-cash control mapping.",
            },
        ],
    }),
    makeFinalTopic({
        ...
        summary: "Practice holder status, defenses, party liability, presentment, dishonor, and notice in commercial-law review.",
        intro: "Negotiable-instrument questions are route-choice traps because a single fact can change the answer from holder protection to defense analysis or notice-of-dishonor analysis.",
        ...
        workedScenario: "A holder takes a note for value before maturity, but the maker raises failure of consideration.",
        workedResult: "Classify holder status first. A personal defense may be cut off if holder-in-due-course elements are proven.",
        checkpointScenario: "A student ignores that the party being sued is an indorser.",
        checkpointResult: "Secondary-party liability needs presentment, dishonor, notice, or a valid excuse analysis.",
        quiz: [
            {
                id: "ni-mc-defense",
                kind: "multiple-choice",
                ...
                answerIndex: 0,
                explanation: "Holder-in-due-course protection is strongest against personal defenses but not against real defenses.",
            },
            {
                id: "ni-tf-secondary",
                kind: "true-false",
                ...
                answer: true,
                explanation: "Secondary liability is not the same as primary maker or acceptor liability.",
            },
            {
                id: "ni-short",
                kind: "short-answer",
                ...
                explanation: "HDC means holder in due course.",
            },
            {
                id: "ni-mc-route",
                kind: "multiple-choice",
                ...
                answerIndex: 0,
                explanation: "The issue spotter keeps holder status, defenses, party liability, and notice together.",
            },
        ],
    }),
    makeFinalTopic({
        ...
        summary: "Connect fraud-triangle signals, management override, evidence quality, and governance escalation.",
        intro: "Fraud-risk cases require both audit response and governance judgment. This module helps students move from risk cues to procedures and escalation.",
        ...
        workedScenario: "Revenue targets are aggressive, manual journal entries rise near year-end, and explanations are supported mostly by internal documents.",
        workedResult: "Use the fraud-risk response route, then connect the result to evidence expansion and governance escalation.",
        checkpointScenario: "A student lists fraud-triangle words but gives no procedure response.",
        checkpointResult: "Fraud-risk identification should lead to changed audit procedures or oversight communication.",
        quiz: [
            {
                ...
                answerIndex: 0,
                explanation: "Override risk should change audit response and may require governance visibility.",
            },
            {
                ...
                answer: true,
                explanation: "Fraud-risk responses often seek more reliable, independent, or corroborative evidence.",
            },
            {
                id: "fraud-short",
                kind: "short-answer",
                ...
                explanation: "High override or stakeholder exposure may require audit committee or board-level escalation.",
            },
            {
                id: "fraud-mc-route",
                kind: "multiple-choice",
                ...
                answerIndex: 0,
                explanation: "The Fraud Risk Response Planner is the dedicated route for this mixed audit-governance issue.",
            },
        ],
    }),
    makeFinalTopic({
        ...
        summary: "Practice choosing between recognition, measurement, presentation, disclosure, and schedule-building routes.",
        intro: "Intermediate accounting problems often look numeric, but the first answer is usually a route choice: recognize, measure, present, disclose, or build a schedule.",
        ...
        workedScenario: "A case asks whether an item should be recognized now, disclosed only, or measured using a later schedule.",
        workedResult: "Use the conceptual framework route first, then open the specific measurement route only after recognition is supported.",
        checkpointScenario: "A student calculates an amount before deciding whether the item qualifies for recognition.",
        checkpointResult: "Recognition comes before measurement in the route discipline.",
        quiz: [
            {
                ...
                answerIndex: 0,
                explanation: "Recognition and classification determine whether measurement belongs in the answer at all.",
            },
            {
                ...
                answer: true,
                explanation: "A good route choice may be conceptual or reviewer-based when recognition or measurement is uncertain.",
            },
            {
                ...
                explanation: "Intermediate route discipline separates recognition, measurement, presentation, disclosure, and classification.",
            },
            {
                ...
                answerIndex: 0,
                explanation: "The conceptual framework helper is designed for recognition and measurement-basis discipline.",
            },
        ],
    }),
];
