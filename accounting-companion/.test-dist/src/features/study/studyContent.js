...
import { STUDY_HUB_EXPANSION_1310_TOPICS } from "./studyExpansion1310.js";
export const STUDY_CATEGORY_DETAILS = {
    ...
    "Statistics / Analytics": {
        description: "Quantitative topics that help students read spread, variation, weighting, and business-use comparisons more carefully.",
...
const CORE_STUDY_TOPICS = [
    {
        ...
        workedExample: {
            ...
            scenario: "A product sells for 120 per unit, variable cost is 70 per unit, and fixed costs are 150,000. The instructor asks for break-even units and the required units for a 60,000 target profit.",
            steps: [
    ...
    },
    {
        ...
        category: "Managerial & Cost Accounting",
        summary: "Study job cost sheets, direct tracing, overhead application, prime cost, conversion cost, and unit-cost reading as one manufacturing-cost workflow.",
        intro: "Job-order costing is used when production is built around specific jobs, orders, or batches rather than a continuous department flow. Students need to trace direct cost correctly, apply overhead carefully, and explain what the resulting unit cost actually means before comparing jobs or quoting prices.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This collects the manufacturing costs assigned to one specific job or batch.",
            },
            {
                label: "Prime cost",
                expression: "Prime cost = Direct materials used + Direct labor",
                explanation: "Prime cost captures the costs directly traceable to the product or job.",
            },
            {
                label: "Conversion cost",
                expression: "Conversion cost = Direct labor + Applied manufacturing overhead",
                explanation: "Conversion cost focuses on the resources used to convert materials into finished output.",
            },
            {
                label: "Unit cost for the job",
                expression: "Unit cost = Total job cost / Units in the job",
                explanation: "This translates the assigned cost of the job into a per-unit reading for pricing, valuation, or comparison.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A custom order uses 85,000 of direct materials, 54,000 of direct labor, and 48,600 of applied manufacturing overhead. The job contains 1,200 completed units.",
            steps: [
            ...
            result: "The job carries a total assigned manufacturing cost of 187,600 and a unit cost of 156.33.",
            interpretation: "The important lesson is not only the arithmetic. Students should also explain whether the unit cost is being driven mainly by materials, labor, or overhead before comparing the job to another order.",
        },
        checkpointExample: {
            title: "Overhead application check",
            scenario: "A student uses total actual factory overhead for the month instead of the overhead applied to the specific job.",
            steps: [
            ...
            result: "The original unit cost is overstated because the denominator is one job but the overhead input came from the whole period.",
            interpretation: "This is a classic wrong-basis error. The arithmetic may look neat while the cost assignment is conceptually wrong.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this short set to verify whether you can identify the right cost-assignment logic before trusting the worksheet totals.",
            questions: [
                {
                    id: "joc-q1",
                    kind: "multiple-choice",
                    prompt: "Which cost should normally be added with direct materials and direct labor on a job cost sheet?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "A job cost sheet combines direct materials, direct labor, and applied manufacturing overhead assigned to that job.",
                },
                {
                    id: "joc-q2",
                    kind: "true-false",
                    prompt: "Job-order costing is generally the better fit when production is continuous and the problem focuses on equivalent units in departments.",
                    answer: false,
                    explanation: "Continuous production with equivalent units points toward process costing, not job-order costing.",
                },
                {
                    id: "joc-q3",
                    kind: "short-answer",
                    prompt: "If a student uses total factory overhead instead of applied overhead for one job, what kind of mistake is that?",
                    acceptedAnswers: [
                        "wrong cost basis",
                    ...
                    placeholder: "Type the likely mistake",
                    explanation: "The student used a period-wide factory total instead of the amount assigned to the specific job, so the cost basis is wrong.",
                },
            ],
        },
    },
...
const STUDY_HUB_EXPANSION_TOPICS = [
    {
        id: "accounting-foundations-review",
        title: "Accounting Foundations Review",
        shortTitle: "Accounting Foundations",
        category: "Financial Accounting",
        summary: "Study the accounting equation, account classification, trial-balance logic, and adjusting entries as one connected review flow.",
        intro: "Foundational accounting problems are really classification and timing problems. This lesson connects transaction effects, normal balances, and end-of-period adjustments so students can explain why an entry is correct instead of memorizing debit-credit patterns blindly.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "Every transaction analysis should still preserve this relationship after the entry is recorded.",
            },
            {
                label: "Adjusted balance logic",
                expression: "Ending balance = Unadjusted balance + Increase adjustments - Decrease adjustments",
                explanation: "This helps explain why the adjustment entry changes the reported ending amount.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A company paid 24,000 for a one-year insurance policy on October 1. At December 31, the student must prepare the adjustment.",
            steps: [
            ...
            result: "The correct adjustment recognizes 6,000 of insurance expense and reduces prepaid insurance by the same amount.",
            interpretation: "The entry does not create new cash movement. It corrects reporting so the remaining asset reflects only the unexpired portion.",
        },
        checkpointExample: {
            title: "Trial-balance quick check",
            scenario: "A student lists Accounts Receivable as a credit balance and Unearned Revenue as an asset. Decide what to review first.",
            steps: [
            ...
            interpretation: "A worksheet can look balanced while still being wrong if the accounts are classified incorrectly.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can connect transaction logic, account type, and period-end adjustments.",
            questions: [
                {
                    id: "afr-q1",
                    kind: "multiple-choice",
                    ...
                    answerIndex: 2,
                    explanation: "Unearned Revenue is a liability, and liabilities normally carry credit balances.",
                },
                {
                    id: "afr-q2",
                    kind: "true-false",
                    prompt: "An adjusting entry usually records new cash received or paid on the adjustment date.",
                    answer: false,
                    explanation: "Most adjusting entries reclassify timing effects so balances match the correct period; they usually do not create new cash movement.",
                },
                {
                    id: "afr-q3",
                    kind: "short-answer",
                    ...
                    explanation: "Adjustments make reported amounts reflect the correct accounting period and improve statement accuracy.",
                },
            ],
        },
    },
    {
        ...
        category: "Financial Accounting",
        summary: "Connect inventory valuation, working-capital logic, liquidity ratios, turnover measures, and statement analysis in one review lesson.",
        intro: "Many accounting problems ask for a ratio or inventory amount, but the deeper skill is understanding what the value says about control, liquidity, and operating efficiency. This lesson ties inventory methods and ratio analysis back to decision reading.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This measures short-term coverage, but it is stronger when read with inventory quality and receivable speed.",
            },
            {
                label: "Inventory turnover",
                expression: "Inventory turnover = Cost of goods sold / Average inventory",
                explanation: "This shows how quickly inventory is sold relative to its average carrying amount.",
            },
            {
                label: "Cash conversion cycle",
                expression: "Cash conversion cycle = Days in inventory + Collection period - Payment period",
                explanation: "This estimates how long cash stays tied up in operating activity.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A business has current assets of 420,000, current liabilities of 210,000, days in inventory of 58, collection period of 34 days, and payment period of 26 days.",
            steps: [
            ...
            result: "The company reports a current ratio of 2.00 and a cash conversion cycle of 66 days.",
            interpretation: "Short-term coverage looks reasonable, but cash is still tied up in operations for more than two months, so inventory and collection discipline still matter.",
        },
        checkpointExample: {
            title: "Inventory method checkpoint",
            scenario: "Under rising costs, compare FIFO with weighted average for ending inventory and cost of goods sold.",
            steps: [
            ...
            result: "Under rising prices, FIFO typically reports higher ending inventory and lower cost of goods sold than weighted average.",
            interpretation: "That can improve gross profit and liquidity-looking figures, but it does not automatically mean operations improved.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this quiz to check whether you can connect valuation and analysis instead of treating them as separate chapters.",
            questions: [
                {
                    id: "irr-q1",
                    kind: "multiple-choice",
                    prompt: "Which ratio most directly measures short-term coverage using current assets and current liabilities?",
                    choices: [
                        "Debt ratio",
                        "Current ratio",
                        "Return on assets",
                    ...
                    answerIndex: 1,
                    explanation: "The current ratio is the standard short-term coverage measure using current assets over current liabilities.",
                },
                {
                    id: "irr-q2",
                    kind: "true-false",
                    ...
                    answer: false,
                    explanation: "Inventory turnover is typically based on average inventory, not just the ending balance.",
                },
                {
                    id: "irr-q3",
                    kind: "short-answer",
                    ...
                    explanation: "A longer cycle usually means operating cash stays committed for a longer period before it returns through collections.",
                },
            ],
        },
    },
    {
        ...
        category: "Financial Accounting",
        summary: "Study adjusted bank balance, adjusted book balance, timing differences, bank-side items, and cash-control interpretation as one disciplined reconciliation workflow.",
        intro: "Bank reconciliation is not just a mechanical check. It is a cash-control process that explains why the bank statement and the company's cash record differ, which items are only timing differences, and which items require immediate book adjustment.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                expression: "Adjusted bank balance = Bank statement balance + Deposits in transit - Outstanding checks +/- Bank error",
                explanation: "The bank side is corrected for timing differences and any identified bank error.",
            },
            {
                label: "Adjusted book balance",
                expression: "Adjusted book balance = Book cash balance - Bank charges - NSF checks + Interest income + Notes collected by bank +/- Book error",
                explanation: "The book side includes items the bank already knows about but the company has not yet recorded correctly.",
            },
            {
                label: "Reconciled cash",
                expression: "Reconciled cash = Adjusted bank balance = Adjusted book balance",
                explanation: "A finished reconciliation ends with one corrected cash amount that both sides support.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "Balance per bank is 52,000 and balance per books is 49,800. Deposits in transit are 6,000, outstanding checks are 4,200, service charges are 300, NSF checks are 700, interest income is 450, and notes collected by the bank are 1,750.",
            steps: [
            ...
            result: "The preliminary reconciliation shows that the current item list is incomplete because the adjusted balances still differ.",
            interpretation: "A mismatch after adjustment is useful evidence. It means the worksheet is still protecting the integrity of cash by forcing another review before the balance is trusted.",
        },
        checkpointExample: {
            title: "Timing versus book-entry checkpoint",
            scenario: "A deposit was recorded by the company on June 30 but did not appear on the bank statement until July 2.",
            steps: [
            ...
            interpretation: "The key distinction is whether the company already recorded the item correctly. If it did, the bank side explains the difference.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this short set to verify whether you can classify reconciling items correctly before trusting the adjusted cash balance.",
            questions: [
                {
                    id: "br-q1",
                    kind: "multiple-choice",
                    prompt: "Which item normally appears on the bank side of a reconciliation because it is a timing difference already recorded by the company?",
                    choices: [
                        "Service charges",
                        "Deposits in transit",
                        "NSF checks",
                    ...
                    answerIndex: 1,
                    explanation: "Deposits in transit were already recorded by the company but not yet by the bank, so they explain the bank-side difference.",
                },
                {
                    id: "br-q2",
                    kind: "true-false",
                    ...
                    answer: true,
                    explanation: "The bank already added the collection, so the company usually needs to increase its book-side cash balance for the same item.",
                },
                {
                    id: "br-q3",
                    kind: "short-answer",
                    prompt: "If the adjusted bank and adjusted book balances still do not match, what does that usually mean?",
                    acceptedAnswers: [
                    ...
                    explanation: "A remaining difference usually means at least one reconciling item or error adjustment is still missing or signed incorrectly.",
                },
            ],
        },
    },
    {
        ...
        category: "Business Math / Finance",
        summary: "Review simple interest, compound growth, present value, future value, annuities, loans, and investment-decision logic as one finance pathway.",
        intro: "Finance questions often look different on the surface, but many of them are still time-value questions. This lesson links single-sum growth, discounting, annuity cash flows, loan schedules, and project evaluation so the student sees one coherent framework.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                expression: "I = P r t",
                explanation: "Simple interest uses principal, rate, and time without compounding between subperiods.",
            },
            {
                label: "Future value of a single sum",
                expression: "FV = PV (1 + i)^n",
                explanation: "This measures how one present amount grows across compounding periods.",
            },
            {
                label: "Present value of a single sum",
                expression: "PV = FV / (1 + i)^n",
                explanation: "This discounts a future amount back to today's value.",
            },
            {
                label: "Net present value",
                expression: "NPV = Present value of inflows - Initial investment",
                explanation: "A positive NPV means the project adds value at the chosen discount rate.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A project requires an initial investment of 180,000 and is expected to generate discounted inflows totaling 212,000 at the required rate.",
            steps: [
            ...
            interpretation: "At the chosen discount rate, the inflows more than recover the investment and required return, so the project is financially acceptable under NPV logic.",
        },
        checkpointExample: {
            title: "Rate-basis checkpoint",
            scenario: "A nominal annual rate is quoted with monthly compounding, but the student uses the annual rate directly for a monthly annuity formula.",
            steps: [
            ...
            result: "The original answer is unreliable because the rate and period bases are inconsistent.",
            interpretation: "Many finance mistakes are not arithmetic errors. They are basis errors involving time and compounding.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to check your rate-basis discipline and investment interpretation.",
            questions: [
                {
                    id: "tvr-q1",
                    kind: "multiple-choice",
                    ...
                    answerIndex: 0,
                    explanation: "A single present amount grows to future value through compounding: FV = PV (1 + i)^n.",
                },
                {
                    id: "tvr-q2",
                    kind: "true-false",
                    prompt: "A positive NPV usually means the project fails to earn the required return.",
                    answer: false,
                    explanation: "A positive NPV means the project exceeds the required return at the discount rate used.",
                },
                {
                    id: "tvr-q3",
                    kind: "short-answer",
                    ...
                    explanation: "Time-value formulas are reliable only when the interest-rate basis and the period basis are consistent.",
                },
            ],
        },
    },
    {
        ...
        category: "Managerial & Cost Accounting",
        summary: "Study cash collections, cash disbursements, cash budgets, flexible budgets, and planning-based entrepreneurship tools from one structured lesson.",
        intro: "Planning tools are connected because each one turns assumptions about sales, collections, payments, and operating activity into a decision-ready plan. This lesson ties those flows together instead of treating each schedule as an isolated form.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                expression: "Ending cash = Beginning cash + Cash collections - Cash disbursements +/- Financing",
                explanation: "This is the final planning view after operating receipts, payments, and required financing are considered.",
            },
            {
                label: "Flexible budget cost pattern",
                expression: "Flexible budget = Fixed cost + (Variable rate x Actual activity)",
                explanation: "This separates activity-driven changes from pure spending variance.",
            },
            {
                label: "Cash runway",
                expression: "Runway = Available cash / Net monthly cash burn",
                explanation: "This estimates how long current cash can support operations when outflows exceed inflows.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A company starts the month with 40,000 cash, expects 180,000 collections, 205,000 disbursements, and wants a minimum cash balance of 25,000.",
            steps: [
            ...
            interpretation: "The issue is timing. Collections and disbursements do not line up closely enough to maintain the required cash floor.",
        },
        checkpointExample: {
            title: "Flexible-budget checkpoint",
            scenario: "Actual units are lower than planned, and the student compares actual total variable cost only to the static budget.",
            steps: [
            ...
            result: "The original comparison is incomplete because it ignores activity-level adjustment.",
            interpretation: "Flexible budgets separate volume effects from spending performance, which is why they are more useful for control.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to check whether you can connect timing, control, and planning interpretation.",
            questions: [
                {
                    id: "bpr-q1",
                    kind: "multiple-choice",
                    prompt: "What should usually be prepared before a final cash budget when sales are collected over time?",
                    choices: [
                    ...
                    answerIndex: 1,
                    explanation: "A cash collections schedule is usually needed first because sales and cash receipts often occur in different periods.",
                },
                {
                    id: "bpr-q2",
                    kind: "true-false",
                    prompt: "A flexible budget is designed to separate activity effects from spending effects.",
                    answer: true,
                    explanation: "That separation is the main reason a flexible budget is more useful for control than a static plan alone.",
                },
                {
                    id: "bpr-q3",
                    kind: "short-answer",
                    ...
                    explanation: "A short runway usually means available cash can support operations for only a limited period unless conditions change.",
                },
            ],
        },
    },
    {
        ...
        category: "Financial Accounting",
        summary: "Study working capital, cash-cycle timing, inventory shrinkage, receivables and payables discipline, and why control-oriented schedules matter before a liquidity problem appears in the statements.",
        intro: "Working capital topics connect liquidity, inventory discipline, receivables collection, and supplier payment timing. This lesson keeps those pieces together so students can explain not only what a ratio or control amount is, but why weak turnover, shrinkage, or payment discipline changes cash pressure.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This shows the short-term asset cushion available to support current obligations.",
            },
            {
                label: "Cash conversion cycle",
                expression: "Cash conversion cycle = Receivables days + Inventory days - Payables days",
                explanation: "This estimates how long cash stays tied up in operating activity before it returns through customer collections.",
            },
            {
                label: "Inventory shrinkage amount",
                expression: "Shrinkage amount = (Book units - Physical units) x Cost per unit",
                explanation: "This measures the value of inventory missing from the count relative to the records.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A company shows receivables days of 42, inventory days of 58, and payables days of 35 while current assets exceed current liabilities by 240,000.",
            steps: [
            ...
            interpretation: "Liquidity looks acceptable on the statement, but turnover discipline still matters because operating cash remains committed for more than two months.",
        },
        checkpointExample: {
            title: "Inventory-control checkpoint",
            scenario: "Book units are 1,200, physical units are 1,160, and cost per unit is 145.",
            steps: [
            ...
            interpretation: "The amount is not just a valuation change. It is a control warning that book records and physical custody are no longer aligned.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to test whether you can read liquidity, timing, and control signals together instead of as isolated numbers.",
            questions: [
                {
                    id: "wcc-q1",
                    kind: "multiple-choice",
                    prompt: "Which formula best represents the cash conversion cycle?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "The cash conversion cycle combines collection time, inventory holding time, and supplier-payment delay into one operating-timing measure.",
                },
                {
                    id: "wcc-q2",
                    kind: "true-false",
                    prompt: "Inventory shrinkage is only a valuation issue and does not suggest any control concern.",
                    answer: false,
                    explanation: "Shrinkage changes valuation, but it also signals a control issue because records and physical inventory no longer agree.",
                },
                {
                    id: "wcc-q3",
                    kind: "short-answer",
                    prompt: "What does a longer cash conversion cycle usually imply?",
                    acceptedAnswers: [
                    ...
                    explanation: "A longer cycle usually means cash stays committed to operations longer before collections convert it back into liquid funds.",
                },
            ],
        },
    },
    {
        ...
        category: "Entrepreneurship",
        summary: "Study startup cost planning, unit economics, pricing, sales forecasting, owner splits, and cash runway as one entrepreneurial decision set.",
        intro: "Startup planning still depends on disciplined contribution logic, pricing assumptions, forecast structure, and cash survival. This lesson connects those ideas into one review path instead of treating entrepreneurship as soft narrative content.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This shows what each sale contributes toward fixed costs, owner return, or growth capacity.",
            },
            {
                label: "Gross margin percentage",
                expression: "Gross margin % = Gross profit / Sales",
                explanation: "This gives a quick view of pricing strength after direct cost coverage.",
            },
            {
                label: "Cash runway",
                expression: "Runway = Available cash / Net monthly burn",
                explanation: "This estimates survival time when current cash must support ongoing operations.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A small venture sells a service package for 1,200 and incurs variable cost of 720 per customer. Fixed monthly costs are 48,000.",
            steps: [
            ...
            result: "The venture needs about 100 customers per month to cover fixed costs.",
            interpretation: "The key decision is not only whether 100 customers is possible, but whether the forecast, acquisition effort, and available cash make that target realistic.",
        },
        checkpointExample: {
            title: "Forecast realism checkpoint",
            scenario: "A startup forecast shows rapid revenue growth, but cash runway is under three months and fixed costs are rising.",
            steps: [
            ...
            result: "The forecast may be too optimistic relative to current cash survival limits.",
            interpretation: "Planning is not only about projected sales. It is also about whether the business can stay alive long enough to reach those sales.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can connect pricing, contribution, and runway into one business reading.",
            questions: [
                {
                    id: "epr-q1",
                    kind: "multiple-choice",
                    prompt: "What should usually be computed before deciding whether pricing can support a startup?",
                    choices: [
                        "Unit contribution",
                        "Consumer surplus",
                        "Inventory turnover",
                    ...
                    answerIndex: 0,
                    explanation: "Unit contribution is a core starting point because it shows how much each sale leaves after variable cost coverage.",
                },
                {
                    id: "epr-q2",
                    kind: "true-false",
                    ...
                    answer: false,
                    explanation: "Runway depends on cash burn and timing, not just on projected sales growth.",
                },
                {
                    id: "epr-q3",
                    kind: "short-answer",
                    ...
                    explanation: "One-time launch spending and recurring operating costs affect feasibility, pricing, and runway in different ways, so they should not be merged carelessly.",
                },
            ],
        },
    },
    {
        ...
        category: "Partnership Accounting",
        summary: "Review profit sharing, salary and interest allowances, admission, retirement, dissolution, and capital rollforward as one partnership workflow.",
        intro: "Partnership accounting is easiest to understand when capital balances are treated as a living cycle. Partners share profit, admit or retire members, and eventually liquidate the business through procedures that all affect capital logic in different ways.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                expression: "Net income - Salary allowances - Interest allowances = Remainder to be shared",
                explanation: "The remainder is distributed using the agreed residual ratio after stated allowances are applied.",
            },
            {
                label: "Capital settlement logic",
                expression: "Ending capital = Beginning capital + Investments + Share of income - Drawings +/- Admission or retirement effects",
                explanation: "This summarizes how capital changes across the partnership life cycle before final liquidation.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "Partners A and B divide net income of 180,000 with salary allowances of 30,000 and 20,000, interest allowances of 10,000 and 8,000, and a remainder ratio of 3:2.",
            steps: [
            ...
            result: "The partners first receive stated allowances, then divide the remaining 112,000 using the residual ratio.",
            interpretation: "This structure prevents students from distributing the entire income by ratio before honoring the agreement's salary and interest provisions.",
        },
        checkpointExample: {
            title: "Admission versus dissolution checkpoint",
            scenario: "A student uses liquidation logic in a partner-admission case because the capital balances are changing.",
            steps: [
            ...
            result: "The original approach is incorrect because the procedure depends on whether the partnership continues or liquidates.",
            interpretation: "Capital change alone does not determine the method. The continuity of the partnership matters.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can distinguish sharing, capital changes, and final liquidation.",
            questions: [
                {
                    id: "pcr-q1",
                    kind: "multiple-choice",
                    prompt: "What should be applied before the residual profit-sharing ratio in a salary-and-interest agreement?",
                    choices: [
                        "Consumer surplus",
                    ...
                    answerIndex: 1,
                    explanation: "The agreement's salary and interest allowances are applied first, then the remaining profit or loss is shared by ratio.",
                },
                {
                    id: "pcr-q2",
                    kind: "true-false",
                    prompt: "Every partnership capital change should automatically be handled as a dissolution problem.",
                    answer: false,
                    explanation: "Admission and retirement can change capital without liquidating the business. Dissolution is a specific final procedure.",
                },
                {
                    id: "pcr-q3",
                    kind: "short-answer",
                    ...
                    explanation: "The statement helps students and instructors follow how each partner's capital changes across the period.",
                },
            ],
        },
    },
    {
        ...
        summary: "Study mean, weighted mean, standard deviation, and coefficient of variation as one analytics toolkit for business comparisons.",
        intro: "Descriptive statistics become more useful when students connect the average, the spread, and the relative size of that spread. This topic keeps those measures together so results are interpreted instead of recited.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This average gives larger influence to values with larger assigned weights or frequencies.",
            },
            {
                label: "Standard deviation",
                expression: "Standard deviation = Square root of variance",
                explanation: "This turns average squared spread back into the original unit of measure.",
            },
            {
                label: "Coefficient of variation",
                expression: "Coefficient of variation = (Standard deviation / Mean) x 100",
                explanation: "This compares variation relative to the average level instead of only in raw units.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "Branch A has a mean weekly sale of 500 with a standard deviation of 50. Branch B has a mean weekly sale of 200 with a standard deviation of 30. The instructor asks which branch is relatively more variable.",
            steps: [
            ...
            result: "Branch B is relatively more variable because 15% exceeds 10%.",
            interpretation: "Even though Branch B has a smaller raw standard deviation, its variation is larger relative to its average level.",
        },
        checkpointExample: {
            title: "Weighted-average checkpoint",
            scenario: "A student averages exam scores equally even though the exams carry different weights.",
            steps: [
            ...
            result: "The simple average is inappropriate because the observations do not carry equal weight.",
            interpretation: "Weighted mean protects the result from being distorted by unequal importance.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this short set to confirm whether you can choose the right statistic before touching the calculator.",
            questions: [
                {
                    id: "stats-q1",
                    kind: "multiple-choice",
                    prompt: "Which measure is best when two datasets have different means and you want a relative comparison of spread?",
                    choices: [
                        "Weighted mean",
                        "Coefficient of variation",
                        "Median only",
                    ...
                    answerIndex: 1,
                    explanation: "Coefficient of variation scales the spread to the mean, making relative comparison possible.",
                },
                {
                    id: "stats-q2",
                    kind: "true-false",
                    prompt: "A weighted mean should be used only when the values are already percentages.",
                    answer: false,
                    explanation: "Weighted means are used whenever observations have different importance or frequency, not only when the values are percentages.",
                },
                {
                    id: "stats-q3",
                    kind: "short-answer",
                    ...
                    explanation: "Standard deviation describes how far the values typically spread around the mean.",
                },
            ],
        },
    },
    {
        ...
        category: "Business Math / Finance",
        summary: "Connect profit and loss, markup, margin, net profit margin, and weighted mean to the pricing decisions students actually face in classwork.",
        intro: "Business math topics are easiest to remember when price, cost, margin, and weighted averages are treated as one connected decision set. This topic ties those formulas to the meaning behind pricing and performance results.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This basic relationship supports pricing, margin, and break-even style reasoning.",
            },
            {
                label: "Markup",
                expression: "Markup % = Profit / Cost x 100",
                explanation: "Markup uses cost as the base, which is why it differs from margin.",
            },
            {
                label: "Margin",
                expression: "Margin % = Profit / Selling price x 100",
                explanation: "Margin uses selling price as the base and is therefore not interchangeable with markup.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "An item costs 500 and sells for 800. The instructor asks for profit, markup, and margin.",
            steps: [
                "Profit = 800 - 500 = 300.",
                "Markup = 300 / 500 x 100 = 60%.",
                "Margin = 300 / 800 x 100 = 37.5%.",
            ],
            result: "The item earns 300 in profit, a 60% markup, and a 37.5% margin.",
            interpretation: "Markup and margin are both correct, but they answer different base questions and must not be reported interchangeably.",
        },
        checkpointExample: {
            title: "Weighted-price checkpoint",
            scenario: "Three product groups have different sales shares, and the teacher asks for one combined average price.",
            steps: [
            ...
            result: "The correct answer is a weighted average, not a simple arithmetic average.",
            interpretation: "The larger groups should influence the combined price more heavily than the smaller groups.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can identify the right base before relying on the calculator.",
            questions: [
                {
                    id: "pricing-q1",
                    kind: "multiple-choice",
                    prompt: "Which base is used when markup percentage is requested?",
                    choices: ["Cost", "Selling price", "Net sales", "Net income"],
                    answerIndex: 0,
                    explanation: "Markup uses cost as the denominator, while margin uses selling price or sales as the denominator.",
                },
                {
                    id: "pricing-q2",
                    kind: "true-false",
                    prompt: "A weighted mean is appropriate only when every observation has the same importance.",
                    answer: false,
                    explanation: "A weighted mean is used precisely because the observations do not all carry equal importance.",
                },
                {
                    id: "pricing-q3",
                    kind: "short-answer",
                    ...
                    explanation: "Markup uses cost as the base, while margin uses selling price or sales as the base.",
                },
            ],
        },
    },
    {
        ...
        category: "Business Math / Finance",
        summary: "Review loan amortization, present and future value of annuities, sinking funds, and effective-rate logic as one payment-planning family.",
        intro: "Many finance problems change only one thing: whether the regular cash flow is being accumulated, discounted, repaid, or compared across compounding methods. This topic keeps those ideas in one place.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "Use this when equal deposits accumulate forward in time.",
            },
            {
                label: "Present value of an ordinary annuity",
                expression: "PV of annuity = Payment x [1 - (1 + i)^(-n)] / i",
                explanation: "Use this when equal future payments are discounted back to today.",
            },
            {
                label: "Effective annual rate",
                expression: "EAR = (1 + nominal rate / m)^m - 1",
                explanation: "Use this to compare compounding structures on one annual basis.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A student wants to understand why a sinking-fund deposit and a loan payment are not the same even when the amount and rate are similar.",
            steps: [
            ...
            result: "Loan payments and sinking-fund deposits solve different finance questions even when the inputs look similar.",
            interpretation: "Students should identify the direction of the cash-flow problem before choosing a formula.",
        },
        checkpointExample: {
            title: "Rate-basis checkpoint",
            scenario: "A nominal annual rate is paired with monthly payments, but the student uses the annual rate directly in the annuity formula.",
            steps: [
            ...
            result: "The original answer is incorrect because the rate basis and period basis were inconsistent.",
            interpretation: "Rate-basis errors are among the most common reasons otherwise-correct annuity work fails.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can choose the correct periodic-payment model before solving.",
            questions: [
                {
                    id: "annuity-q1",
                    kind: "multiple-choice",
                    prompt: "Which issue should be checked first in a monthly annuity problem?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "Monthly payments require a monthly-period rate basis before the formula can be used correctly.",
                },
                {
                    id: "annuity-q2",
                    kind: "true-false",
                    prompt: "A sinking-fund deposit and a loan payment solve the same cash-flow direction problem.",
                    answer: false,
                    explanation: "A sinking fund accumulates toward a future target, while a loan payment repays a present obligation.",
                },
                {
                    id: "annuity-q3",
                    kind: "short-answer",
                    ...
                    placeholder: "Type why it is useful",
                    explanation: "Effective annual rate converts compounding structures into one comparable annual reading.",
                },
            ],
        },
    },
    {
        ...
        category: "Entrepreneurship",
        summary: "Study startup cost planning, sales forecasting, unit economics, and cash runway as one early-stage planning sequence.",
        intro: "Entrepreneurship tools are most useful when startup cost, sales forecast, unit economics, and cash runway are read as one planning chain. This topic keeps those ideas connected so feasibility stays disciplined.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This is the operating cash movement that drives runway interpretation.",
            },
            {
                label: "Cash runway",
                expression: "Runway (months) = Opening cash / Monthly burn",
                explanation: "Use this only when monthly burn is positive and recurring.",
            },
            {
                label: "Unit contribution",
                expression: "Unit contribution = Selling price - Variable cost per unit",
                explanation: "This links startup pricing to whether growth adds cash or only activity.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A startup has 600,000 in opening cash, expected monthly inflows of 120,000, and monthly outflows of 180,000.",
            steps: [
            ...
            result: "The plan has 10 months of runway under the current assumptions.",
            interpretation: "The number is only useful if the inflow and outflow assumptions are realistic and updated as new information arrives.",
        },
        checkpointExample: {
            title: "Forecast caution checkpoint",
            scenario: "A student projects aggressive sales growth without checking whether unit economics remain positive.",
            steps: [
            ...
            result: "The plan is incomplete because growth alone does not guarantee sustainability.",
            interpretation: "Forecasts must be tested against contribution and cash logic, not only optimism.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to confirm whether you can read runway and forecast outputs as planning signals instead of isolated numbers.",
            questions: [
                {
                    id: "runway-q1",
                    kind: "multiple-choice",
                    prompt: "Which value is most directly used to compute runway months?",
                    choices: [
                        "Monthly burn",
                        "Markup percentage",
                        "Debt ratio",
                    ...
                    answerIndex: 0,
                    explanation: "Runway depends on opening cash and the monthly burn or net outflow assumption.",
                },
                {
                    id: "runway-q2",
                    kind: "true-false",
                    prompt: "A long runway always means the business model is profitable.",
                    answer: false,
                    explanation: "Runway measures time supported by cash assumptions. Profitability and cash timing are related but not identical.",
                },
                {
                    id: "runway-q3",
                    kind: "short-answer",
                    ...
                    placeholder: "Type the reason",
                    explanation: "Growth should be tested against contribution and cash logic because more volume does not automatically improve viability.",
                },
            ],
        },
    },
    {
        ...
        category: "Managerial & Cost Accounting",
        summary: "Review capacity utilization, idle capacity, flexible budgets, and cash-planning follow-up as one operations-sensitive planning path.",
        intro: "Managers do not only ask whether output happened. They ask whether the operation used capacity wisely, whether cost behavior adjusted properly, and whether the plan should be revised. This topic ties those decisions together.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This shows how much of realistic available capacity the operation used.",
            },
            {
                label: "Idle capacity",
                expression: "Idle capacity = Practical capacity - Actual output",
                explanation: "This shows the portion of available capacity that stayed unused.",
            },
            {
                label: "Flexible budget",
                expression: "Flexible budget = Fixed costs + (Actual units x Variable cost per unit)",
                explanation: "This updates the cost expectation to the actual activity level before spending is judged.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "Actual output is 8,400 units against practical capacity of 10,000 units. The teacher then asks whether a flexible-budget review is the right next step.",
            steps: [
            ...
            result: "The operation used 84% of practical capacity and still has 1,600 units of idle capacity.",
            interpretation: "The next useful question is not only how much capacity is unused, but whether costs behaved appropriately at that activity level.",
        },
        checkpointExample: {
            title: "Idle-capacity checkpoint",
            scenario: "A student treats unused capacity as automatically unfavorable performance in every context.",
            steps: [
            ...
            result: "Idle capacity is a signal that requires context, not an automatic verdict.",
            interpretation: "A utilization result becomes meaningful only after demand, cost, and planning context are considered together.",
        },
        interpretation: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can interpret utilization as part of a planning process instead of reading it in isolation.",
            questions: [
                {
                    id: "capacity-q1",
                    kind: "multiple-choice",
                    prompt: "What does idle capacity represent?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "Idle capacity is the available practical capacity that stayed unused during the period.",
                },
                {
                    id: "capacity-q2",
                    kind: "true-false",
                    prompt: "A high utilization rate always means the operation is in the best possible condition.",
                    answer: false,
                    explanation: "Very high utilization can also signal strain, bottlenecks, or weak operational slack.",
                },
                {
                    id: "capacity-q3",
                    kind: "short-answer",
                    ...
                    placeholder: "Type the reason",
                    explanation: "Flexible budgets update the cost expectation to actual activity so cost interpretation becomes fairer.",
                },
            ],
        },
    },
...
const STUDY_TOPICS = [
    ...
    ...STUDY_HUB_EXPANSION_1310_TOPICS,
];
