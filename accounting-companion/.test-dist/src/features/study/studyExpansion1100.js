function makeTopic(seed) {
    return {
        ...
        formulaOverview: [
            {
                ...
                expression: "Classify the primary issue -> apply the core framework -> explain the consequence -> route to the next tool",
                explanation: "These modules are designed to make students pause and structure the answer before chasing details.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            interpretation: "A good result is not just the final label. It is the structured explanation that makes the route choice defensible.",
        },
        checkpointExample: {
            ...
            interpretation: "The checkpoint is here to stop the wrong route before it contaminates the whole answer.",
        },
        interpretation: [
            ...
            [
                {
                    ...
                    summary: "Use this section to keep the idea organized before it becomes a long unstructured answer.",
                    points: [
            ...
            questions: [
                {
                    ...
                    answerIndex: 0,
                    explanation: "These topics are designed to improve classification and route choice before students commit to detailed solving.",
                },
                {
                    id: `${seed.id}-tf-1`,
                    kind: "true-false",
                    ...
                    answer: true,
                    explanation: "The strongest review answers explain what the issue means, not just what it is called.",
                },
                {
                    id: `${seed.id}-short-1`,
                    kind: "short-answer",
                    ...
                    explanation: "The primary issue or route choice should be checked first so the answer does not drift into the wrong tool.",
...
export const STUDY_HUB_EXPANSION_1100_TOPICS = [
    makeTopic({
        ...
        summary: "Review business continuity planning, disaster recovery, vendor dependence, incident response, and communication readiness in AIS cases.",
        intro: "AIS continuity questions often look technical, but students usually earn points by explaining recovery objectives, control readiness, and the practical response when systems fail.",
        focus: "AIS continuity posture, recovery gaps, and response readiness",
        workedScenario: "A company has daily backups but unclear incident escalation, weak vendor fallback, and an expected recovery time longer than the case RTO.",
        workedResult: "The better answer says backup design alone is not enough. The recovery gap and weak escalation path keep continuity risk elevated.",
        checkpointScenario: "A student concludes the continuity plan is strong because backups exist, even though communication and vendor dependence are weak.",
        checkpointResult: "Continuity strength comes from the full response chain, not just one technical control.",
    ...
    makeTopic({
        ...
        summary: "Review tone at the top, accountability, ethics programs, competence, and escalation logic when governance and internal-control cases need a clearer answer path.",
        intro: "Governance questions often stay too abstract. This module makes the control environment concrete by tying oversight, competence, escalation, and override risk together.",
        focus: "control-environment quality, override risk, and escalation readiness",
        workedScenario: "A finance team meets technical deadlines, but escalation channels are weak and management frequently overrides approval steps under pressure.",
        workedResult: "The answer should say the control environment is not strong enough because override risk and weak escalation undermine the rest of the framework.",
        checkpointScenario: "A student praises strong policy manuals without discussing actual enforcement or escalation behavior.",
        checkpointResult: "Documentation alone does not prove a strong control environment.",
    ...
    makeTopic({
        ...
        summary: "Review void, voidable, unenforceable, and rescissible contracts while keeping ratification, annulment, rescission, and enforcement consequences visible.",
        intro: "Students often memorize labels without understanding the legal consequence. This lesson keeps defect type, remedy, and enforceability tied together.",
        focus: "defect classification, enforceability, and remedy consequences",
        workedScenario: "A party claims intimidation affected consent, while the facts also suggest later acts that may confirm the agreement.",
        workedResult: "The case should be framed as potentially voidable, with ratification checked before concluding annulment is still available.",
        checkpointScenario: "A student immediately labels the contract void even though the issue is really vitiated consent.",
        checkpointResult: "The better route is to ask whether the case is voidable and whether later conduct changed the remedy.",
    ...
    makeTopic({
        ...
        summary: "Review business-case structure by balancing market attractiveness, execution readiness, control readiness, and risk before making a recommendation.",
        intro: "Strategic questions feel stronger when students present an explicit recommendation supported by trade-offs instead of writing long unfocused commentary.",
        focus: "business-case recommendation quality and strategic trade-off framing",
        workedScenario: "A proposed expansion has strong market potential, moderate cost advantage, weak controls, and a nontrivial execution risk.",
        workedResult: "A solid answer recommends refining or staging the proposal instead of approving it blindly because controls and execution readiness still drag the case down.",
        checkpointScenario: "A student recommends full rollout just because the market signal is attractive.",
        checkpointResult: "Strategic cases need balanced evaluation, not one-metric enthusiasm.",
    ...
    }),
    {
        ...
        summary: "Connect allowance estimation, cash discounts, discounted notes, and related cash-control reading so receivables topics feel like one working family instead of isolated formulas.",
        intro: "Receivables problems often mix valuation, timing, and settlement language. This module keeps bad-debt estimation, cash-discount reading, and notes handling connected so students can classify the issue before choosing the tool.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "Use this when the case asks for the target allowance or the needed adjustment based on expected collectibility.",
            },
            {
                label: "Cash discount amount",
                expression: "Cash discount = Invoice amount x discount rate",
                explanation: "Use this when the customer pays within the discount period and the issue is settlement terms, not note discounting.",
            },
            {
                label: "Bank discount",
                expression: "Bank discount = Maturity value x bank discount rate x time",
                explanation: "Use this when a note is discounted before maturity and the question asks for proceeds or discount withheld.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A company estimates 4% of a 900,000 receivable balance as uncollectible, offers 2/10, n/30 terms on a 120,000 invoice, and later discounts a note with maturity value of 210,000.",
            steps: [
            ...
            result: "The lesson is not one single number. It is the ability to route allowance, discount-terms, and discounted-note questions correctly.",
            interpretation: "Receivables topics are safer when students stop treating every cash-related prompt as the same problem type.",
        },
        checkpointExample: {
            title: "Receivables routing checkpoint",
            scenario: "A student uses a cash-discount formula on a note-discounting problem because both mention a discount.",
            steps: [
            ...
            result: "The correct route is note discounting, not customer cash-discount terms.",
            interpretation: "Terminology overlap is one of the main reasons students choose the wrong calculator for receivables problems.",
        },
        interpretation: [
        ...
        deepDiveSections: [
            {
                ...
                summary: "Use this section when several receivable-related terms appear in one prompt and the correct route is getting blurry.",
                points: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can separate receivable valuation, settlement discounts, and note discounting before computing.",
            questions: [
                {
                    id: "receivables-q1",
                    kind: "multiple-choice",
                    prompt: "Which issue is most likely being tested when the prompt gives a receivable balance and an estimated uncollectible rate?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "A receivable balance with an estimated uncollectible rate usually points to allowance estimation or the needed bad-debt adjustment.",
                },
                {
                    id: "receivables-q2",
                    kind: "multiple-choice",
                    prompt: "The phrase 2/10, n/30 most directly points to which route?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "Terms such as 2/10, n/30 describe an early-payment discount for the customer, not a bank discount on a note.",
                },
                {
                    id: "receivables-q3",
                    kind: "true-false",
                    prompt: "A bank discount on a note is usually computed after maturity value is identified.",
                    answer: true,
                    explanation: "The note-discounting workflow typically computes maturity value first, then determines the bank discount and proceeds.",
                },
                {
                    id: "receivables-q4",
                    kind: "short-answer",
                    prompt: "What should a student confirm first when both the words discount and note appear in the same problem?",
                    acceptedAnswers: [
                        "whether it is cash discount or note discounting",
                        "whether the discount is customer terms or bank discount",
                        "the type of discount",
                    ],
                    explanation: "The first routing question is whether the discount comes from customer settlement terms or from discounting a note before maturity.",
    ...
    },
    {
        ...
        summary: "Connect high-low estimation, contribution thinking, margin of safety, and target-profit planning so cost-behavior problems lead into better managerial decisions.",
        intro: "Cost-behavior problems become more useful when students move from estimating the mixed-cost pattern into break-even, target-profit, and margin-of-safety interpretation instead of stopping at one formula.",
        whyItMatters: [
        ...
        formulaOverview: [
            {
                ...
                explanation: "This estimate is the first step before building the fixed-cost portion of the mixed cost.",
            },
            {
                label: "Margin of safety",
                expression: "Margin of safety = Actual or expected sales - Break-even sales",
                explanation: "This measures the buffer before sales fall to the break-even threshold.",
            },
            {
                label: "Target-profit units",
                expression: "Required units = (Fixed costs + Target profit) / Contribution margin per unit",
                explanation: "Use this after the cost behavior and contribution margin have been clarified.",
            },
        ],
        variableDefinitions: [
        ...
        workedExample: {
            ...
            scenario: "A mixed cost rises from 120,000 at 8,000 units to 156,000 at 14,000 units. The product sells for 45 per unit, and management wants to know whether expected sales leave enough safety margin.",
            steps: [
            ...
            result: "The value of the lesson is the bridge from estimation into planning, not the estimate by itself.",
            interpretation: "Students should explain how a mixed-cost estimate changes the later planning answer instead of treating the topics separately.",
        },
        checkpointExample: {
            title: "Planning checkpoint",
            scenario: "A student computes the high-low estimate but never uses it to comment on margin of safety or target-profit pressure.",
            steps: [
            ...
            result: "A high-low answer is incomplete if it never reaches the planning implication.",
            interpretation: "Managerial questions usually reward the decision meaning of the estimate, not just the estimate itself.",
        },
        interpretation: [
        ...
        deepDiveSections: [
            {
                ...
                summary: "Use this section when the problem feels split between cost-behavior estimation and later planning interpretation.",
                points: [
        ...
        quiz: {
            ...
            intro: "Use this set to verify whether you can connect mixed-cost estimation to break-even and planning interpretation.",
            questions: [
                {
                    id: "cost-behavior-q1",
                    kind: "multiple-choice",
                    prompt: "What is usually computed first in the high-low method?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "The high-low method first estimates the variable portion per unit from the cost change over the activity change.",
                },
                {
                    id: "cost-behavior-q2",
                    kind: "multiple-choice",
                    prompt: "Which statement best describes margin of safety?",
                    choices: [
                    ...
                    answerIndex: 0,
                    explanation: "Margin of safety measures how far expected or actual sales sit above the break-even threshold.",
                },
                {
                    id: "cost-behavior-q3",
                    kind: "true-false",
                    prompt: "A weak cost-behavior estimate can distort later target-profit planning.",
                    answer: true,
                    explanation: "CVP and target-profit answers rely on the estimated fixed and variable cost pattern, so a weak estimate can contaminate the later planning result.",
                },
                {
                    id: "cost-behavior-q4",
                    kind: "short-answer",
                    prompt: "Why should a student move past the high-low estimate into a planning interpretation?",
                    acceptedAnswers: [
                        "because the estimate supports break-even or target profit",
                        "because it helps planning",
                        "because it shows margin of safety",
                    ],
                    explanation: "Managerial cases usually use the estimate to support a planning judgment such as break-even, target profit, or margin-of-safety reading.",
