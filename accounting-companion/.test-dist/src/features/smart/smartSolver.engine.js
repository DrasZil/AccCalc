...
import { FLEXIBLE_NUMBER_CAPTURE_PATTERN, parseLooseNumber, } from "../../utils/numberParsing.js";
/* -------------------------------------------------------------------------- */
/* FIELDS */
/* -------------------------------------------------------------------------- */
...
export const CALCULATORS = [
    {
        id: "conceptual-framework-recognition",
        name: "Conceptual Framework Recognition Helper",
        route: "/far/conceptual-framework-recognition",
        description: "Best when the prompt asks whether an item is an asset, liability, income, expense, disclosure issue, or measurement-basis question.",
        required: [],
        aliases: ["conceptual framework", "recognition helper", "measurement basis"],
        keywords: [
            /conceptual framework/i,
            /recognition criteria/i,
            /asset definition/i,
            /liability definition/i,
            /measurement basis/i,
            /disclosure/i,
    ...
    {
        id: "revenue-allocation-workspace",
        name: "Revenue Allocation Workspace",
        route: "/far/revenue-allocation-workspace",
        description: "Best when the prompt gives a bundled contract, standalone selling prices, performance obligations, or contract asset/liability facts.",
        required: [],
        aliases: ["revenue allocation", "transaction price allocation", "performance obligation"],
        keywords: [
            /revenue allocation/i,
            /revenue recognition/i,
            /performance obligation/i,
            /standalone selling price/i,
            /transaction price/i,
            /contract asset/i,
    ...
    {
        id: "taxable-income-bridge",
        name: "Taxable Income Bridge",
        route: "/tax/taxable-income-bridge",
        description: "Best when the prompt asks for taxable income from accounting income using permanent or temporary differences.",
        required: [],
        aliases: ["taxable income bridge", "income tax bridge", "income taxation"],
        keywords: [
            /taxable income/i,
            /income tax/i,
            /permanent difference/i,
            /temporary difference/i,
            /deferred tax/i,
            /nolco/i,
            /book tax/i,
        ],
    ...
    {
        id: "audit-evidence-program-builder",
        name: "Audit Evidence Program Builder",
        route: "/audit/evidence-program-builder",
        description: "Best when the prompt asks about audit evidence sufficiency, reliability, relevance, contradictions, or procedure intensity.",
        required: [],
        aliases: ["audit evidence program", "evidence sufficiency", "audit procedure builder"],
        keywords: [
            /audit evidence/i,
            /sufficient appropriate evidence/i,
            /evidence reliability/i,
            /evidence relevance/i,
            /contradictory evidence/i,
            /substantive procedures/i,
            /assertion risk/i,
        ],
    },
    {
        id: "target-costing-workspace",
        name: "Target Costing Workspace",
        route: "/strategic/target-costing-workspace",
        description: "Best when the prompt asks for target cost, allowable cost, target profit, kaizen savings, or strategic cost gap.",
        required: [],
        aliases: ["target costing", "allowable cost", "cost gap"],
        keywords: [
            /target costing/i,
            /target cost/i,
            /allowable cost/i,
    ...
    },
    {
        ...
        description: "Best when the user wants a broader CVP read that combines contribution margin, break-even, target profit, margin of safety, operating leverage, and sensitivity cues in one page.",
        required: [],
        optional: [
            "fixedCosts",
            "sellingPricePerUnit",
    ...
    },
    {
        ...
        description: "Best when the user is converting budgeted sales and finished-goods policy into required production units.",
        required: [
            "budgetedSalesUnits",
            "desiredEndingFinishedGoodsUnits",
            "beginningFinishedGoodsUnits",
    ...
    },
    {
        ...
        description: "Best when the user wants materials required, materials to purchase, or budgeted purchases cost from a production plan.",
        required: [
            "budgetedProductionUnits",
            "materialsPerFinishedUnit",
            "desiredEndingMaterialsUnits",
    ...
    },
    {
        ...
        description: "Best when the user needs required labor hours or total labor cost from planned production volume and wage assumptions.",
    ...
    },
    {
        ...
        description: "Best when the user needs a manufacturing-overhead budget split into variable and fixed components.",
    ...
    },
    {
        ...
        description: "Best when the user needs merchandise purchases from budgeted cost of goods sold plus ending-inventory policy.",
        required: [
            "budgetedCostOfGoodsSold",
            "desiredEndingInventoryCost",
            "beginningInventoryCost",
    ...
    },
    {
        ...
        description: "Best when the user needs budgeted sales revenue, planned unit sales, or implied selling price from a sales-budget setup.",
    ...
    },
    {
        ...
        description: "Best when the user needs total or cash operating expenses from budgeted sales, variable-rate expenses, and fixed costs.",
        required: [
            "budgetedSalesAmount",
            "variableExpenseRatePercent",
            "fixedOperatingExpenses",
    ...
    },
    {
        ...
        description: "Best when the user wants a pro forma income statement from budgeted sales, COGS, operating expenses, interest, and tax.",
    ...
    },
    {
        ...
        description: "Best when the user wants incremental profit or a break-even price for a one-time special order.",
    ...
    },
    {
        ...
        description: "Best when the user wants relevant make cost, relevant buy cost, or the indifference purchase price.",
    ...
    },
    {
        ...
        description: "Best when the user compares split-off value against additional processing revenue and separable cost.",
    ...
    },
    {
        ...
        description: "Best when the user ranks a product by contribution margin per scarce-resource unit.",
    ...
    },
    {
        ...
        description: "Best when the user needs a minimum transfer price, an outside-market ceiling, or a negotiation range for divisional transfer pricing.",
    ...
    },
    {
        ...
        description: "Best when the user wants spending variance, activity variance, or the total budget gap.",
    ...
    },
    {
        ...
        description: "Best when the user compares actual sales volume with budgeted sales volume using a budgeted contribution margin per unit.",
    ...
    },
    {
        ...
        description: "Best when the user needs the effect of actual product mix versus budgeted sales mix.",
    ...
    },
    {
        ...
        description: "Best when the user compares actual output with practical or available capacity and wants idle-capacity interpretation.",
    ...
    },
    {
        ...
        description: "Best when the user needs a weighted average from values with different frequencies, shares, or importance.",
        required: [],
        aliases: [
            "weighted mean",
            "weighted average",
    ...
    },
    {
        ...
        description: "Best when the user asks for variance, standard deviation, dispersion, or spread of a numeric dataset.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants relative variability or a spread comparison across datasets with different means.",
        required: [],
        aliases: [
    ...
    },
    {
        ...
        description: "Best when the user needs maturity value, bank discount, or proceeds from discounting a note before maturity.",
    ...
    },
    {
        ...
        description: "Best when the user is proving a petty cash fund using cash on hand, vouchers, stamps, and a short-or-over check.",
    ...
    },
    {
        ...
        description: "Best when the problem involves realization, liquidation, deficiency handling, or final partner cash distribution during dissolution.",
        required: [],
        aliases: [
    ...
    },
    {
        ...
        description: "Best when the problem asks for total job cost, unit cost, prime cost, conversion cost, or applied overhead assigned to a specific job or batch.",
        required: [
            "directMaterialsUsed",
            "directLabor",
            "manufacturingOverhead",
    ...
    },
    {
        ...
        description: "Best when the user needs a full process-costing workspace with equivalent units, departmental schedules, transferred-in cost, or cost reconciliation.",
        required: [],
        aliases: [
    ...
    },
    {
        ...
        description: "Best when the user wants prepaid, unearned, accrued revenue, or accrued expense adjustments from one structured worksheet.",
        required: [],
        aliases: [
            "adjusting entries",
    ...
    },
    {
        ...
        description: "Best when the user is adjusting a prepaid asset into expense recognized for the period.",
    ...
    },
    {
        ...
        description: "Best when the user is moving part of unearned revenue into earned revenue through an adjusting entry.",
    ...
    },
    {
        ...
        description: "Best when revenue has been earned before collection and the user needs the accrued amount or adjustment.",
    ...
    },
    {
        ...
        description: "Best when an expense has been incurred before payment and the user needs the accrued amount or adjustment.",
    ...
    },
    {
        ...
        description: "Best when the user wants current ratio, operating cycle, receivables days, inventory days, or cash conversion cycle in one planner.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants shrinkage and purchase-discount control signals in one inventory review.",
        required: [],
        aliases: [
            "inventory control",
            "inventory shrinkage",
    ...
    },
    {
        ...
        description: "Best when the user wants midpoint elasticity, elastic versus inelastic classification, or price-response analysis.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants equilibrium price and quantity from linear demand and supply equations.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants consumer surplus, producer surplus, or total surplus at equilibrium.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants to compare nominal rate, inflation, and real purchasing-power return.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants to compare price, income, and cross elasticity from one guided workspace.",
        required: [],
        aliases: [
    ...
    },
    {
        ...
        description: "Best when the user wants launch costs, contingency planning, or a startup funding estimate.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants contribution per unit, CAC impact, or break-even customers from one startup worksheet.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants simple month-based revenue growth planning or a startup sales forecast.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants burn rate or runway planning from opening cash and monthly cash flow assumptions.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants pricing targets, owner profit splits, or customer payback from one small-business worksheet.",
        required: [],
        aliases: [
    ...
    },
    {
        ...
        description: "Estimate variable and fixed cost components from high-low activity data.",
        required: [],
    ...
    },
    {
        ...
        description: "Compare ROI, residual income, and EVA-style performance reading from one route.",
        required: [],
    ...
    },
    {
        ...
        description: "Plan economic order quantity and reorder point from one inventory route.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user wants safety stock and reorder point from average and maximum usage plus lead time assumptions.",
    ...
    },
    {
        ...
        description: "Forecast short-term demand using simple and weighted moving averages.",
    ...
    },
    {
        ...
        description: "Best when the user allocates total dividends between preferred and common shareholders, including preferred arrears when present.",
    ...
    },
    {
        ...
        description: "Review lease liability and right-of-use asset measurement from one FAR route.",
        required: [],
    ...
    },
    {
        ...
        description: "Review equity-settled share-based payment measurement and compensation cost timing.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user is comparing carrying amount with recoverable amount using fair value less costs to sell and value in use.",
    ...
    },
    {
        ...
        description: "Best when the user needs book value, net proceeds, or gain or loss on disposal of property, plant, and equipment.",
    ...
    },
    {
        ...
        description: "Build and classify operating, investing, and financing cash flows.",
        required: [],
    ...
    },
    {
        ...
        description: "Review planning materiality, performance materiality, and audit-risk response.",
        required: [],
    ...
    {
        id: "audit-misstatement-evaluation",
        name: "Audit Misstatement Evaluation Workspace",
        route: "/audit/misstatement-evaluation-workspace",
        description: "Evaluate projected plus allowance misstatement against tolerable misstatement while keeping clearly trivial and qualitative pressure visible.",
        required: [],
        aliases: ["projected misstatement", "allowance for sampling risk", "misstatement evaluation", "clearly trivial threshold"],
        keywords: [/projected misstatement/i, /allowance for sampling risk/i, /tolerable misstatement/i, /clearly trivial/i, /misstatement evaluation/i],
    },
    {
        id: "audit-materiality-and-misstatement-planner",
        name: "Audit Materiality and Misstatement Planner",
        route: "/audit/materiality-and-misstatement-planner",
        description: "Plan audit materiality, performance materiality, clearly trivial thresholds, and misstatement cushion.",
        required: [],
        aliases: ["audit materiality planner", "performance materiality", "clearly trivial", "misstatement cushion"],
        keywords: [/audit materiality/i, /planning materiality/i, /performance materiality/i, /clearly trivial/i, /uncorrected misstatement/i],
    },
    {
        id: "audit-cycle-reviewer",
        name: "Audit Cycle Reviewer",
        route: "/audit/audit-cycle-reviewer",
        description: "Review transaction-cycle assertions, controls, and likely procedures.",
        required: [],
    ...
    },
    {
        ...
        description: "Review completion procedures, going concern, modified reports, and KAMs.",
        required: [],
    ...
    },
    {
        ...
        description: "Bridge accounting income and taxable income through book-tax differences.",
        required: [],
    ...
    {
        id: "income-tax-payable-review",
        name: "Income Tax Payable and Credits Review",
        route: "/tax/income-tax-payable-review",
        description: "Reconcile taxable income, tax due, credits, payments, penalties, payable, and overpayment.",
        required: [],
        aliases: ["income tax payable", "tax credits", "tax overpayment", "quarterly tax payments"],
        keywords: [/income tax payable/i, /withholding credits?/i, /quarterly payments?/i, /tax overpayment/i, /tax refund/i],
    },
    {
        id: "vat-reconciliation",
        name: "VAT Reconciliation",
        route: "/tax/vat-reconciliation",
        description: "Best when the user is comparing output VAT and input VAT to read the net payable or excess-input position.",
    ...
    },
    {
        ...
        description: "Best when the user is computing tax withheld or net proceeds after withholding from a payment base and rate.",
    ...
    },
    {
        ...
        description: "Best when the user wants net estate and estate tax due from gross estate, deductions, and a visible tax rate assumption.",
    ...
    },
    {
        ...
        description: "Best when the user needs taxable gift or donor's tax due using visible classroom assumptions.",
    ...
    },
    {
        ...
        description: "Best when the user needs DST due from a taxable base amount, unit size, and rate per taxable unit.",
    ...
    },
    {
        ...
        description: "Review withholding, transfer taxes, treaty handling, and incentive regimes.",
        required: [],
    ...
    },
    {
        ...
        description: "Study goodwill, NCI measurement, and acquisition-date business-combination logic.",
        required: [],
    ...
    },
    {
        ...
        description: "Best when the user needs the unrealized intercompany profit still embedded in ending inventory.",
    ...
    },
    {
        ...
        description: "Best when the user wants the carrying amount of an associate investment after share in income and dividends.",
    ...
    },
    {
        ...
        description: "Best when the user needs consignee commission, related charges, and the balance still due to the consignor.",
    ...
    },
    {
        ...
        description: "Best when the user converts branch inventory at billed price into loading allowance and inventory at cost.",
    ...
    },
    {
        ...
        description: "Best when the user needs remaining unrealized gain or excess depreciation on an intercompany PPE transfer.",
    ...
    },
    {
        ...
        description: "Review transaction-date, closing-rate, and settlement-rate foreign-currency effects.",
        required: [],
    ...
    },
    {
        ...
        description: "Review long-term construction revenue, percent complete, and contract position.",
        required: [],
    ...
    },
    {
        ...
        description: "Review IT governance, general controls, and application-control implications.",
        required: [],
    ...
    },
    {
        ...
        description: "Review ERP, continuity, disaster recovery, and systems life-cycle concerns.",
        required: [],
    ...
    },
    {
        ...
        description: "Score continuity readiness, compare expected recovery with the target RTO, and keep AIS disruption cases structured.",
        required: [],
    ...
    {
        id: "segregation-of-duties-conflict",
        name: "Segregation of Duties Conflict Matrix",
        route: "/ais/segregation-of-duties-conflict-matrix",
        description: "Score incompatible-duty conflicts and compensating review strength so AIS and IT-audit role-overlap cases stay structured.",
        required: [],
        aliases: [
            "segregation of duties matrix",
            "sod conflict",
            "incompatible duties",
            "role overlap controls",
            "compensating review weakness",
        ],
        keywords: [
            /segregation of duties/i,
            /\bsod\b/i,
            /incompatible duties/i,
            /compensating review/i,
            /role overlap/i,
            /same user can/i,
            /authorize .*record/i,
            /record .*privileged access/i,
        ],
    },
    {
        ...
        description: "Review commercial-law, securities, procurement, and rehabilitation topics.",
        required: [],
    ...
    },
    {
        ...
        description: "Estimate capitalizable borrowing cost for qualifying assets using average accumulated expenditures, a capitalization rate, and the construction period.",
        required: [],
    ...
    },
    {
        ...
        description: "Bridge costing and pricing by turning cost, target margin language, and target income into a usable selling-price plan.",
        required: [],
    ...
    },
    {
        ...
        description: "Choose assertion-focused procedures and working-paper direction from the audit cycle, risk, and control-reliance mix in a case.",
        required: [],
    ...
    },
    {
        ...
        description: "Review excise tax, local taxation, and incentive-regime issues in one route when the problem is more conceptual than purely computational.",
        required: [],
    ...
    },
    {
        ...
        description: "Map ERP, SCM, CRM, and data-flow control issues so AIS cases connect systems modules to control design and audit implications.",
        required: [],
    ...
    },
    {
        ...
        description: "Frame governance, ethics, risk, and control-environment dilemmas through practical decision prompts instead of leaving them as isolated reviewer notes.",
        required: [],
    ...
    },
    {
        ...
        description: "Evaluate oversight, ethics, accountability, competence, and escalation readiness in governance cases.",
        required: [],
    ...
    {
        id: "governance-escalation-planner",
        name: "Governance Escalation Planner",
        route: "/governance/governance-escalation-planner",
        description: "Translate issue severity, override risk, stakeholder exposure, and oversight readiness into a clearer escalation tier.",
        required: [],
        aliases: ["governance escalation", "audit committee escalation", "board escalation", "override escalation"],
        keywords: [/governance escalation/i, /audit committee/i, /board escalation/i, /stakeholder exposure/i, /override risk/i],
    },
    {
        id: "securities-and-governance-review",
        name: "Securities and Governance Review",
        route: "/rfbt/securities-and-governance-review",
        description: "Review securities regulation, insider trading, corporate-governance, and disclosure topics inside the RFBT track.",
        required: [],
    ...
    },
    {
        ...
        description: "Turn strategic objectives into a four-perspective performance story so integrative cases link planning, controls, and accountability.",
        required: [],
    ...
    },
    {
        ...
        description: "Map mixed-topic cases before choosing the detailed route.",
        required: [],
    ...
    },
    {
        ...
        description: "Review strategic analysis, strategic cost management, and consultancy framing.",
        required: [],
    ...
    },
    {
        ...
        description: "Blend market, execution, control, and risk signals into a cleaner strategic recommendation.",
        required: [],
    ...
    },
    {
        ...
        description: "Decompose ROE into profit margin, asset turnover, and leverage when statement-analysis prompts ask why returns changed.",
        required: [],
    ...
    },
    {
        ...
        description: "Compare net income with operating cash flow when a financial-statement analysis prompt asks about accrual pressure or quality of earnings.",
        required: [],
    ...
    },
    {
        ...
        description: "Estimate a probability-weighted provision for FAR cases involving contingencies, obligations, and multiple possible outcomes.",
        required: [],
    ...
    },
    {
        ...
        description: "Analyze initial franchise fee revenue using satisfied performance obligation and collectability assumptions.",
        required: [],
    ...
    },
    {
        ...
        description: "Analyze retail pricing cases with markup, markdown, maintained margin, revenue, and gross profit.",
        required: [],
    ...
    },
    {
        ...
        description: "Build a z or t confidence interval for statistics, audit sampling, forecasting, or marketing-research estimates.",
        required: [],
    ...
    },
    {
        ...
        description: "Compare profitability-index ranking with exact project-combination selection under a limited capital budget.",
        required: [],
    ...
    },
    {
        ...
        description: "Compute contribution margin, segment margin, and allocated common-cost effect for responsibility-accounting cases.",
        required: [],
    ...
    },
    {
        ...
        description: "Estimate sample size, sampling interval, and allowance for sampling risk from population, tolerable misstatement, expected misstatement, and confidence factor.",
        required: [],
    ...
    },
    {
        ...
        description: "Use optimistic, most-likely, and pessimistic estimates to compute expected project time and uncertainty.",
        required: [],
    ...
    },
    {
        ...
        description: "Review whether share premium, revaluation surplus, and capital reduction can remove a deficit under classroom assumptions.",
        required: [],
    ...
    },
    {
        ...
        description: "Estimate net estate available, unsecured creditor recovery, and deficiency for corporate liquidation review.",
        required: [],
    ...
    },
    {
        ...
        description: "Classify obligations, defective contracts, remedies, and next review steps for RFBT prompts.",
        required: [],
    ...
    {
        id: "negotiable-instruments-issue-spotter",
        name: "Negotiable Instruments Issue Spotter",
        route: "/rfbt/negotiable-instruments-issue-spotter",
        description: "Classify holder status, defenses, party liability, presentment, dishonor, and notice issues.",
        required: [],
        aliases: ["negotiable instruments", "holder in due course", "dishonor notice", "commercial paper"],
        keywords: [/negotiable instruments?/i, /holder in due course/i, /\bhdc\b/i, /presentment/i, /dishonor/i, /notice of dishonor/i],
    },
    {
        id: "defective-contracts-classifier",
        name: "Defective Contracts Classifier",
        route: "/rfbt/defective-contracts-classifier",
        description: "Classify defective contracts while keeping enforceability, ratification, and remedy logic visible.",
        required: [],
    ...
    },
    {
        ...
        description: "Review logical access, privileged access, change risk, monitoring, and evidence needs in AIS and IT-audit cases.",
        required: [],
        aliases: ["logical access", "privileged access", "access control"],
        keywords: [/logical access/i, /privileged access/i, /access controls?/i],
    },
    {
        id: "revenue-cycle-control-review",
        name: "Revenue Cycle Control Review",
        route: "/ais/revenue-cycle-control-review",
        description: "Map order-to-cash controls to assertions, walkthrough evidence, weak control gaps, and audit follow-up.",
        required: [],
        aliases: ["revenue cycle controls", "sales cycle controls", "order to cash controls"],
        keywords: [/revenue cycle/i, /order to cash/i, /sales order approval/i, /invoice sequence/i, /cash application/i, /exception report/i],
    },
    {
        id: "fraud-risk-response-planner",
        name: "Fraud Risk Response Planner",
        route: "/governance/fraud-risk-response-planner",
        description: "Convert fraud triangle, management override, and evidence-quality signals into audit and governance response steps.",
        required: [],
        aliases: ["fraud risk response", "fraud triangle", "management override", "professional skepticism"],
        keywords: [/fraud risk/i, /fraud triangle/i, /management override/i, /professional skepticism/i, /journal entry testing/i],
    },
    {
        id: "activity-based-costing",
        name: "Activity-Based Costing Allocator",
        route: "/business/activity-based-costing",
        description: "Allocate activity cost pools with driver rates and compute product overhead, total cost, and unit product cost.",
        required: [],
    ...
    },
    {
        ...
        description: "Compute effective-interest revenue, cash interest, amortization, and ECL-adjusted carrying amount for financial assets.",
        required: [],
    ...
    },
    {
        ...
        description: "Compare fair value model gain or loss with cost-model carrying amount for investment property cases.",
        required: [],
    ...
    },
    {
        ...
        description: "Estimate a venturer's share of assets, liabilities, revenue, expenses, and profit with joint-operation classification reminders.",
        required: [],
    ...
    },
    {
        ...
        description: "Build three-sigma control limits and flag out-of-control observations for operations quality-control cases.",
        required: [],
    ...
    },
    {
        ...
        route: "/workpapers",
        description: "Use when the user wants a workbook, workpaper, spreadsheet-style schedule, or exportable solving file rather than a single one-off result.",
        required: [],
...
const SPECIAL_ROUTE_FAMILY_RULES = [
    {
...
const SPECIAL_ROUTE_FAMILY_BY_CALCULATOR_ID = new Map(SPECIAL_ROUTE_FAMILY_RULES.flatMap((family) => family.calculatorIds.map((calculatorId) => [calculatorId, family])));
...
function getRouteFamilyRule(calculator) {
    const special = SPECIAL_ROUTE_FAMILY_BY_CALCULATOR_ID.get(calculator.id);
    if (special) {
        return {
            ...special,
            extractionFieldKeys: special.extractionFieldKeys ??
                dedupeFieldKeys(special.calculatorIds.flatMap((calculatorId) => {
                    const matchedCalculator = CALCULATORS.find((entry) => entry.id === calculatorId);
...
function getTopicFamilyConfidence(score) {
    if (score >= 70)
        return "high";
    if (score >= 42)
        return "moderate";
...
function isStudyFirstPrompt(query) {
    if (!query.trim())
        return false;
    const studySignals = (query.match(/\b(explain|lesson|learn|study|reviewer|review|concept|why|meaning|difference between|theory|journalize)\b/gi) ?? [])
        .length;
    const calculatorSignals = (query.match(/\b(calculate|compute|solve|determine|prepare|cash budget|bank reconciliation|break[- ]even|intercompany|depreciation)\b/gi) ?? [])
        .length;
    return studySignals >= 2 && calculatorSignals === 0;
}
function findNearbyAliasWindow(text, aliases) {
    if (!aliases.length)
        return "";
...
function sanitizeExtractedFactValue(key, value, query) {
    ...
    const explicitDateNearby = /\b(year ended|fiscal year|calendar year|as of|dated|date)\b/i.test(nearbyWindow);
    if (meta.kind === "percent") {
        if (looksLikeCalendarYear(numericValue))
            return null;
        if (!explicitPercentNearby && Math.abs(numericValue) > 100)
            return null;
    }
    if (meta.kind === "money" && looksLikeCalendarYear(numericValue) && !explicitDateNearby) {
        return null;
    }
    if ((meta.kind === "number" || meta.kind === "time") &&
        key !== "year" &&
        key !== "years" &&
        key !== "yearsInArrears" &&
...
let activeExtractionGuardContext = null;
function withExtractionGuardContext(context, run) {
...
function computeTopicSignalScore(calculator, query) {
    ...
    const familyMatches = (familyRule.positivePatterns ?? []).filter((pattern) => pattern.test(query)).length;
    const contradictionPenalty = (familyRule.contradictionPatterns ?? []).filter((pattern) => pattern.test(query)).length *
        12;
    const topicScore = keywordMatches * 12 +
        aliasMatches * 14 +
        nameMatches * 8 +
        familyMatches * 10 -
...
function rankTopicFamilies(query) {
...
function extractNumberByAliases(text, aliases, options) {
    ...
    return extractFirstNumber(text, [
        new RegExp(`(?:${joined})${fillerWords}\\s*${numericCapture}${percentSuffix}`, "i"),
        new RegExp(`${numericCapture}${percentSuffix}${fillerWords}\\s*(?:${joined})`, "i"),
        new RegExp(`(?:${joined})[^\\d\\n]{0,24}${numericCapture}${percentSuffix}`, "i"),
        new RegExp(`${numericCapture}${percentSuffix}[^\\d\\n]{0,24}(?:${joined})`, "i"),
    ]);
}
...
function setFact(target, key, value) {
    if (value === null || value === undefined || value === "")
        return;
    if (activeExtractionGuardContext?.allowedFields &&
        !activeExtractionGuardContext.allowedFields.has(key))
        return;
    if (target[key])
        return;
    const sanitized = sanitizeExtractedFactValue(key, value, activeExtractionGuardContext?.query ?? "");
    if (!sanitized)
        return;
    target[key] = sanitized;
}
function applyMirrors(facts) {
    const canSet = (field) => !activeExtractionGuardContext?.allowedFields ||
        activeExtractionGuardContext.allowedFields.has(field);
    if (facts.principal) {
        if (canSet("loanAmount") && !facts.loanAmount)
            facts.loanAmount = facts.principal;
        if (canSet("presentValue") && !facts.presentValue)
...
/* EXTRACTION */
/* -------------------------------------------------------------------------- */
export function extractFacts(query, allowedFields) {
    ...
    return withExtractionGuardContext({
        ...
        const pettyCashVouchers = extractNumberByAliases(text, FIELD_META.pettyCashVouchers.aliases ?? []);
        ...
        const shortageOrOverage = extractNumberByAliases(text, FIELD_META.shortageOrOverage.aliases ?? []);
        const beginningPrepaid = extractNumberByAliases(text, FIELD_META.beginningPrepaid.aliases ?? []);
        const endingPrepaid = extractNumberByAliases(text, FIELD_META.endingPrepaid.aliases ?? []);
        const expenseRecognized = extractNumberByAliases(text, FIELD_META.expenseRecognized.aliases ?? []);
        const beginningUnearnedRevenue = extractNumberByAliases(text, FIELD_META.beginningUnearnedRevenue.aliases ?? []);
        const endingUnearnedRevenue = extractNumberByAliases(text, FIELD_META.endingUnearnedRevenue.aliases ?? []);
        const revenueRecognized = extractNumberByAliases(text, FIELD_META.revenueRecognized.aliases ?? []);
        ...
        const accruedRevenue = extractNumberByAliases(text, FIELD_META.accruedRevenue.aliases ?? []);
        const expenseIncurred = extractNumberByAliases(text, FIELD_META.expenseIncurred.aliases ?? []);
        ...
        const fairValueLessCostsToSell = extractNumberByAliases(text, FIELD_META.fairValueLessCostsToSell.aliases ?? []);
        ...
        const accumulatedDepreciation = extractNumberByAliases(text, FIELD_META.accumulatedDepreciation.aliases ?? []);
        ...
        const budgetedSalesUnits = extractNumberByAliases(text, FIELD_META.budgetedSalesUnits.aliases ?? [], { allowCurrency: false });
        const desiredEndingFinishedGoodsUnits = extractNumberByAliases(text, FIELD_META.desiredEndingFinishedGoodsUnits.aliases ?? [], { allowCurrency: false });
        const beginningFinishedGoodsUnits = extractNumberByAliases(text, FIELD_META.beginningFinishedGoodsUnits.aliases ?? [], { allowCurrency: false });
        const requiredProductionUnits = extractNumberByAliases(text, FIELD_META.requiredProductionUnits.aliases ?? [], { allowCurrency: false });
        const budgetedProductionUnits = extractNumberByAliases(text, FIELD_META.budgetedProductionUnits.aliases ?? [], { allowCurrency: false });
        const materialsPerFinishedUnit = extractNumberByAliases(text, FIELD_META.materialsPerFinishedUnit.aliases ?? [], { allowCurrency: false });
        const desiredEndingMaterialsUnits = extractNumberByAliases(text, FIELD_META.desiredEndingMaterialsUnits.aliases ?? [], { allowCurrency: false });
        const beginningMaterialsUnits = extractNumberByAliases(text, FIELD_META.beginningMaterialsUnits.aliases ?? [], { allowCurrency: false });
        const materialCostPerUnit = extractNumberByAliases(text, FIELD_META.materialCostPerUnit.aliases ?? []);
        const materialsToPurchaseUnits = extractNumberByAliases(text, FIELD_META.materialsToPurchaseUnits.aliases ?? [], { allowCurrency: false });
        const purchasesCost = extractNumberByAliases(text, FIELD_META.purchasesCost.aliases ?? []);
        const directLaborHoursPerUnit = extractNumberByAliases(text, FIELD_META.directLaborHoursPerUnit.aliases ?? [], { allowCurrency: false });
        const directLaborRatePerHour = extractNumberByAliases(text, FIELD_META.directLaborRatePerHour.aliases ?? []);
        const totalDirectLaborHours = extractNumberByAliases(text, FIELD_META.totalDirectLaborHours.aliases ?? [], { allowCurrency: false });
        const totalDirectLaborCost = extractNumberByAliases(text, FIELD_META.totalDirectLaborCost.aliases ?? []);
        const variableOverheadRatePerUnit = extractNumberByAliases(text, FIELD_META.variableOverheadRatePerUnit.aliases ?? []);
        const fixedOverheadBudget = extractNumberByAliases(text, FIELD_META.fixedOverheadBudget.aliases ?? []);
        const variableFactoryOverheadBudget = extractNumberByAliases(text, FIELD_META.variableFactoryOverheadBudget.aliases ?? []);
        const totalFactoryOverheadBudget = extractNumberByAliases(text, FIELD_META.totalFactoryOverheadBudget.aliases ?? []);
        const budgetedCostOfGoodsSold = extractNumberByAliases(text, FIELD_META.budgetedCostOfGoodsSold.aliases ?? []);
        const desiredEndingInventoryCost = extractNumberByAliases(text, FIELD_META.desiredEndingInventoryCost.aliases ?? []);
        const beginningInventoryCost = extractNumberByAliases(text, FIELD_META.beginningInventoryCost.aliases ?? []);
        const purchasesRequiredCost = extractNumberByAliases(text, FIELD_META.purchasesRequiredCost.aliases ?? []);
        const budgetedSalesAmount = extractNumberByAliases(text, FIELD_META.budgetedSalesAmount.aliases ?? []);
        const specialOrderUnits = extractNumberByAliases(text, FIELD_META.specialOrderUnits.aliases ?? [], { allowCurrency: false });
        const specialOrderPricePerUnit = extractNumberByAliases(text, FIELD_META.specialOrderPricePerUnit.aliases ?? []);
        const incrementalFixedCosts = extractNumberByAliases(text, FIELD_META.incrementalFixedCosts.aliases ?? []);
        const incrementalRevenue = extractNumberByAliases(text, FIELD_META.incrementalRevenue.aliases ?? []);
        const incrementalCost = extractNumberByAliases(text, FIELD_META.incrementalCost.aliases ?? []);
        const incrementalProfit = extractNumberByAliases(text, FIELD_META.incrementalProfit.aliases ?? []);
        const minimumAcceptablePricePerUnit = extractNumberByAliases(text, FIELD_META.minimumAcceptablePricePerUnit.aliases ?? []);
        const unitsNeeded = extractNumberByAliases(text, FIELD_META.unitsNeeded.aliases ?? [], { allowCurrency: false });
        const variableManufacturingCostPerUnit = extractNumberByAliases(text, FIELD_META.variableManufacturingCostPerUnit.aliases ?? []);
        const avoidableFixedCosts = extractNumberByAliases(text, FIELD_META.avoidableFixedCosts.aliases ?? []);
        const purchasePricePerUnit = extractNumberByAliases(text, FIELD_META.purchasePricePerUnit.aliases ?? []);
        const relevantMakeCost = extractNumberByAliases(text, FIELD_META.relevantMakeCost.aliases ?? []);
        const relevantBuyCost = extractNumberByAliases(text, FIELD_META.relevantBuyCost.aliases ?? []);
        const costAdvantageAmount = extractNumberByAliases(text, FIELD_META.costAdvantageAmount.aliases ?? []);
        const maximumAcceptablePurchasePricePerUnit = extractNumberByAliases(text, FIELD_META.maximumAcceptablePurchasePricePerUnit.aliases ?? []);
        const salesValueAtSplitoffPerUnit = extractNumberByAliases(text, FIELD_META.salesValueAtSplitoffPerUnit.aliases ?? []);
        const salesValueAfterProcessingPerUnit = extractNumberByAliases(text, FIELD_META.salesValueAfterProcessingPerUnit.aliases ?? []);
        const separableProcessingCostPerUnit = extractNumberByAliases(text, FIELD_META.separableProcessingCostPerUnit.aliases ?? []);
        const incrementalRevenueFromProcessing = extractNumberByAliases(text, FIELD_META.incrementalRevenueFromProcessing.aliases ?? []);
        const incrementalProfitFromProcessing = extractNumberByAliases(text, FIELD_META.incrementalProfitFromProcessing.aliases ?? []);
        const minimumFurtherProcessingPricePerUnit = extractNumberByAliases(text, FIELD_META.minimumFurtherProcessingPricePerUnit.aliases ?? []);
        const constrainedResourceUnitsPerProduct = extractNumberByAliases(text, FIELD_META.constrainedResourceUnitsPerProduct.aliases ?? [], { allowCurrency: false });
        const constrainedResourceAvailableUnits = extractNumberByAliases(text, FIELD_META.constrainedResourceAvailableUnits.aliases ?? [], { allowCurrency: false });
        const contributionMarginPerConstraintUnit = extractNumberByAliases(text, FIELD_META.contributionMarginPerConstraintUnit.aliases ?? []);
        const maximumUnitsFromConstraint = extractNumberByAliases(text, FIELD_META.maximumUnitsFromConstraint.aliases ?? [], { allowCurrency: false });
        const totalContributionMarginAtConstraint = extractNumberByAliases(text, FIELD_META.totalContributionMarginAtConstraint.aliases ?? []);
        const actualResultAmount = extractNumberByAliases(text, FIELD_META.actualResultAmount.aliases ?? []);
        const flexibleBudgetAmount = extractNumberByAliases(text, FIELD_META.flexibleBudgetAmount.aliases ?? []);
        const staticBudgetAmount = extractNumberByAliases(text, FIELD_META.staticBudgetAmount.aliases ?? []);
        const spendingVariance = extractNumberByAliases(text, FIELD_META.spendingVariance.aliases ?? []);
        const activityVariance = extractNumberByAliases(text, FIELD_META.activityVariance.aliases ?? []);
        const totalBudgetVariance = extractNumberByAliases(text, FIELD_META.totalBudgetVariance.aliases ?? []);
        const taxableSalesAmount = extractNumberByAliases(text, FIELD_META.taxableSalesAmount.aliases ?? []);
        const vatablePurchasesAmount = extractNumberByAliases(text, FIELD_META.vatablePurchasesAmount.aliases ?? []);
        const vatRatePercent = extractNumberByAliases(text, FIELD_META.vatRatePercent.aliases ?? [], { percent: true });
        const netVatPayable = extractNumberByAliases(text, FIELD_META.netVatPayable.aliases ?? []);
        const variableExpenseRatePercent = extractNumberByAliases(text, FIELD_META.variableExpenseRatePercent.aliases ?? [], { percent: true });
        const fixedOperatingExpenses = extractNumberByAliases(text, FIELD_META.fixedOperatingExpenses.aliases ?? []);
        const nonCashOperatingExpenses = extractNumberByAliases(text, FIELD_META.nonCashOperatingExpenses.aliases ?? []);
        const totalOperatingExpenses = extractNumberByAliases(text, FIELD_META.totalOperatingExpenses.aliases ?? []);
        const cashOperatingExpenses = extractNumberByAliases(text, FIELD_META.cashOperatingExpenses.aliases ?? []);
        const grossProfit = extractNumberByAliases(text, FIELD_META.grossProfit.aliases ?? []);
        const incomeBeforeTax = extractNumberByAliases(text, FIELD_META.incomeBeforeTax.aliases ?? []);
        const dividendsDeclared = extractNumberByAliases(text, FIELD_META.dividendsDeclared.aliases ?? []);
        const investorShareInIncome = extractNumberByAliases(text, FIELD_META.investorShareInIncome.aliases ?? []);
        const dividendsReceived = extractNumberByAliases(text, FIELD_META.dividendsReceived.aliases ?? []);
        const endingInvestmentBalance = extractNumberByAliases(text, FIELD_META.endingInvestmentBalance.aliases ?? []);
        const maturityValue = extractNumberByAliases(text, FIELD_META.maturityValue.aliases ?? []);
        const bankDiscountAmount = extractNumberByAliases(text, FIELD_META.bankDiscountAmount.aliases ?? []);
        const proceedsFromDiscounting = extractNumberByAliases(text, FIELD_META.proceedsFromDiscounting.aliases ?? []);
        ...
        const markupRateOnCostPercent = extractNumberByAliases(text, FIELD_META.markupRateOnCostPercent.aliases ?? [], { percent: true });
        const percentUnsoldAtPeriodEnd = extractNumberByAliases(text, FIELD_META.percentUnsoldAtPeriodEnd.aliases ?? [], { percent: true });
        const unrealizedProfitInEndingInventory = extractNumberByAliases(text, FIELD_META.unrealizedProfitInEndingInventory.aliases ?? []);
        const annualExcessDepreciation = extractNumberByAliases(text, FIELD_META.annualExcessDepreciation.aliases ?? []);
        const unamortizedIntercompanyProfit = extractNumberByAliases(text, FIELD_META.unamortizedIntercompanyProfit.aliases ?? []);
        ...
        const period1Demand = extractNumberByAliases(text, FIELD_META.period1Demand.aliases ?? [], { allowCurrency: false });
        const period2Demand = extractNumberByAliases(text, FIELD_META.period2Demand.aliases ?? [], { allowCurrency: false });
        const period3Demand = extractNumberByAliases(text, FIELD_META.period3Demand.aliases ?? [], { allowCurrency: false });
        ...
        const simpleMovingAverageForecast = extractNumberByAliases(text, FIELD_META.simpleMovingAverageForecast.aliases ?? [], { allowCurrency: false });
        const weightedMovingAverageForecast = extractNumberByAliases(text, FIELD_META.weightedMovingAverageForecast.aliases ?? [], { allowCurrency: false });
        const actualUnitsSold = extractNumberByAliases(text, FIELD_META.actualUnitsSold.aliases ?? [], { allowCurrency: false });
        const budgetedUnitsSold = extractNumberByAliases(text, FIELD_META.budgetedUnitsSold.aliases ?? [], { allowCurrency: false });
        const budgetedContributionMarginPerUnit = extractNumberByAliases(text, FIELD_META.budgetedContributionMarginPerUnit.aliases ?? []);
        const salesVolumeVariance = extractNumberByAliases(text, FIELD_META.salesVolumeVariance.aliases ?? []);
        const actualTotalUnitsSold = extractNumberByAliases(text, FIELD_META.actualTotalUnitsSold.aliases ?? [], { allowCurrency: false });
        const actualProductUnitsSold = extractNumberByAliases(text, FIELD_META.actualProductUnitsSold.aliases ?? [], { allowCurrency: false });
        const budgetedMixPercent = extractNumberByAliases(text, FIELD_META.budgetedMixPercent.aliases ?? [], { percent: true });
        const actualMixPercent = extractNumberByAliases(text, FIELD_META.actualMixPercent.aliases ?? [], { percent: true });
        const salesMixVariance = extractNumberByAliases(text, FIELD_META.salesMixVariance.aliases ?? []);
        const averageDailyUsage = extractNumberByAliases(text, FIELD_META.averageDailyUsage.aliases ?? [], { allowCurrency: false });
        const maxDailyUsage = extractNumberByAliases(text, FIELD_META.maxDailyUsage.aliases ?? [], { allowCurrency: false });
        const averageLeadTimeDays = extractNumberByAliases(text, FIELD_META.averageLeadTimeDays.aliases ?? [], { allowCurrency: false });
        const maxLeadTimeDays = extractNumberByAliases(text, FIELD_META.maxLeadTimeDays.aliases ?? [], { allowCurrency: false });
        ...
        const allowableDeductions = extractNumberByAliases(text, FIELD_META.allowableDeductions.aliases ?? []);
        const taxRatePercent = extractNumberByAliases(text, FIELD_META.taxRatePercent.aliases ?? [], { percent: true });
        ...
        const taxableBaseAmount = extractNumberByAliases(text, FIELD_META.taxableBaseAmount.aliases ?? []);
        const taxableUnitSize = extractNumberByAliases(text, FIELD_META.taxableUnitSize.aliases ?? []);
        ...
        const documentaryStampTaxDue = extractNumberByAliases(text, FIELD_META.documentaryStampTaxDue.aliases ?? []);
        const commissionRatePercent = extractNumberByAliases(text, FIELD_META.commissionRatePercent.aliases ?? [], { percent: true });
        const freightAndOtherExpenses = extractNumberByAliases(text, FIELD_META.freightAndOtherExpenses.aliases ?? []);
        const advancesRemitted = extractNumberByAliases(text, FIELD_META.advancesRemitted.aliases ?? []);
        const commissionAmount = extractNumberByAliases(text, FIELD_META.commissionAmount.aliases ?? []);
        const cashStillDueToConsignor = extractNumberByAliases(text, FIELD_META.cashStillDueToConsignor.aliases ?? []);
        const billedPriceInventory = extractNumberByAliases(text, FIELD_META.billedPriceInventory.aliases ?? []);
        const loadingPercentOnCost = extractNumberByAliases(text, FIELD_META.loadingPercentOnCost.aliases ?? [], { percent: true });
        const loadingRateOnBilledPrice = extractNumberByAliases(text, FIELD_META.loadingRateOnBilledPrice.aliases ?? [], { percent: true });
        const inventoryLoadingAllowance = extractNumberByAliases(text, FIELD_META.inventoryLoadingAllowance.aliases ?? []);
        const inventoryAtCost = extractNumberByAliases(text, FIELD_META.inventoryAtCost.aliases ?? []);
        const totalDividendsDeclared = extractNumberByAliases(text, FIELD_META.totalDividendsDeclared.aliases ?? []);
        const preferredShares = extractNumberByAliases(text, FIELD_META.preferredShares.aliases ?? [], { allowCurrency: false });
        const preferredParValue = extractNumberByAliases(text, FIELD_META.preferredParValue.aliases ?? []);
        const preferredDividendRatePercent = extractNumberByAliases(text, FIELD_META.preferredDividendRatePercent.aliases ?? [], { percent: true });
        const yearsInArrears = extractNumberByAliases(text, FIELD_META.yearsInArrears.aliases ?? [], { allowCurrency: false });
        const commonSharesOutstanding = extractNumberByAliases(text, FIELD_META.commonSharesOutstanding.aliases ?? [], { allowCurrency: false });
        const preferredDividendAllocated = extractNumberByAliases(text, FIELD_META.preferredDividendAllocated.aliases ?? []);
        const commonDividendAllocated = extractNumberByAliases(text, FIELD_META.commonDividendAllocated.aliases ?? []);
        const commonDividendPerShare = extractNumberByAliases(text, FIELD_META.commonDividendPerShare.aliases ?? []);
        ...
        setFact(facts, "budgetedContributionMarginPerUnit", budgetedContributionMarginPerUnit);
...
/* SCORING */
/* -------------------------------------------------------------------------- */
export function buildReason(calculator, merged, query, topicScore = 0, fieldScore = 0) {
...
function scoreFieldContribution(calculator, merged, extracted) {
    let score = 0;
...
export function scoreCalculator(calculator, merged, extracted, topicScore, contradictionPenalty, familyGatePenalty) {
...
export function buildFollowUp(best, secondBest, query = "", topicFamily = null, warnings = []) {
...
export function analyzeSmartInput(fields, smartInput) {
    ...
    const topicFamilyGap = topicFamily && topicFamilies[1]
        ? topicFamily.score - topicFamilies[1].score
        : null;
    const strongFamilyGate = Boolean(topicFamily &&
    ...
    const extractionFamilies = topicFamily
        ? strongFamilyGate
            ...
            : topicFamilies
                ...
                .slice(0, 2)
        : [];
    const allowedFieldKeys = extractionFamilies.length > 0
        ? dedupeFieldKeys(extractionFamilies.flatMap((family) => family.calculatorIds.flatMap((calculatorId) => {
    ...
    if (isStudyFirstPrompt(normalizedQuery)) {
        warnings.push("The prompt looks more like a study or explanation request than a single calculator instruction.");
    }
    if (topicFamilyGap !== null && topicFamilyGap <= 6 && topicFamilies[1]) {
        warnings.push(`Topic-family routing is still close between ${topicFamily.label} and ${topicFamilies[1].label}.`);
    }
    const ranked = CALCULATORS.map((calculator) => {
        const topicSignals = computeTopicSignalScore(calculator, normalizedQuery);
        const familyGatePenalty = strongFamilyGate && topicFamily && topicSignals.familyRule.id !== topicFamily.id
            ? 24
            : topicFamily && topicSignals.familyRule.id !== topicFamily.id
                ? 10
                : 0;
        const score = scoreCalculator(calculator, merged, extracted, topicSignals.topicScore, 0, familyGatePenalty);
    ...
    const relatedCalculatorIds = best ? getRouteFamilyRule(best).relatedCalculatorIds ?? [] : [];
    const secondaryRoutes = ranked
        .filter((calculator) => calculator.id !== best?.id)
        .filter((calculator) => relatedCalculatorIds.includes(calculator.id) ||
        (calculator.score >= 35 && calculator.topicScore >= 24))
        .slice(0, 4);
    const extractedEntries = (allowedFieldKeys && allowedFieldKeys.length > 0 ? allowedFieldKeys : FIELD_KEYS).flatMap((key) => (extracted[key] !== "" ? [[key, extracted[key]]] : []));
    if (best && best.familyGatePenalty > 0 && best.score < 55) {
        warnings.push("The selected route is being held below auto-open strength because the topic signals are still mixed.");
    }
    return {
        extracted,
        merged,
        ...
        hasStrongMatch: Boolean(best &&
            best.score >= 55 &&
            !isStudyFirstPrompt(normalizedQuery) &&
            topicFamily?.confidence !== "low"),
        isReadyToRoute: Boolean(best &&
            best.score >= 55 &&
