...
export const retainedEarningsRollforwardSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "beginningRetainedEarnings"
                ...
                value: targetKey === "beginningRetainedEarnings"
...
export const percentageTaxSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "taxableSales")
            return ["taxDue", "ratePercent"];
        if (targetKey === "ratePercent")
            return ["taxableSales", "taxDue"];
    ...
    solve(targetKey, values) {
        ...
        if (targetKey === "taxableSales") {
            if (ratePercent <= 0)
                return { error: "Rate must be greater than zero when solving for taxable sales." };
            taxableSales = taxDue / (ratePercent / 100);
        }
        else if (targetKey === "ratePercent") {
            if (taxableSales <= 0)
                return { error: "Taxable sales must be greater than zero when solving for the rate." };
        ...
        return {
            primaryResult: {
                title: targetKey === "taxableSales"
                    ? "Taxable Sales"
                    : targetKey === "ratePercent"
                        ? "Rate"
                        : "Percentage Tax Due",
                value: targetKey === "taxableSales"
            ...
            assumptions: buildTaxAssumptionNotes(PHILIPPINE_TAX_ASSUMPTIONS.percentageTax, ["This tool is for percentage-tax drills and assumes the tax base is already identified correctly for the scenario."]),
            warnings: [
...
export const accountingRateOfReturnSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "averageAnnualAccountingIncome")
            return ["initialInvestment", "salvageValue", "accountingRateOfReturnPercent"];
        if (targetKey === "initialInvestment")
            return ["averageAnnualAccountingIncome", "salvageValue", "accountingRateOfReturnPercent"];
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "averageAnnualAccountingIncome"
                    ? "Average Annual Accounting Income"
                    : targetKey === "initialInvestment"
                        ? "Initial Investment"
                        : "ARR",
                value: targetKey === "averageAnnualAccountingIncome"
...
export const equivalentAnnualAnnuitySolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        if (projectLife <= 0)
            return { error: "Project life must be greater than zero." };
        if (discountRatePercent < 0)
            return { error: "Discount rate cannot be negative." };
        ...
        return {
            primaryResult: {
                ...
                value: targetKey === "netPresentValue"
...
export const pettyCashReconciliationSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        const shortOverLabel = computed.shortageOrOverage === 0
            ? "Balanced"
...
export const prepaidExpenseAdjustmentSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "beginningPrepaid")
            return ["endingPrepaid", "expenseRecognized"];
        if (targetKey === "endingPrepaid")
            return ["beginningPrepaid", "expenseRecognized"];
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "beginningPrepaid"
                    ? "Beginning Prepaid"
                    : targetKey === "endingPrepaid"
                        ? "Ending Prepaid"
                        : "Expense Recognized",
                value: targetKey === "beginningPrepaid"
...
export const unearnedRevenueAdjustmentSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "beginningUnearnedRevenue")
            return ["endingUnearnedRevenue", "revenueRecognized"];
        if (targetKey === "endingUnearnedRevenue")
            return ["beginningUnearnedRevenue", "revenueRecognized"];
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "beginningUnearnedRevenue"
                    ? "Beginning Unearned Revenue"
                    : targetKey === "endingUnearnedRevenue"
                        ? "Ending Unearned Revenue"
                        : "Revenue Recognized",
                value: targetKey === "beginningUnearnedRevenue"
...
export const accruedRevenueAdjustmentSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "revenueEarned")
            return ["cashCollected", "accruedRevenue"];
        if (targetKey === "cashCollected")
            return ["revenueEarned", "accruedRevenue"];
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "revenueEarned"
                    ? "Revenue Earned"
                    : targetKey === "cashCollected"
                        ? "Cash Collected"
                        : "Accrued Revenue",
                value: targetKey === "revenueEarned"
...
export const accruedExpenseAdjustmentSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "expenseIncurred")
            return ["cashPaid", "accruedExpense"];
        if (targetKey === "cashPaid")
            return ["expenseIncurred", "accruedExpense"];
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "expenseIncurred"
                    ? "Expense Incurred"
                    : targetKey === "cashPaid"
                        ? "Cash Paid"
                        : "Accrued Expense",
                value: targetKey === "expenseIncurred"
...
export const impairmentLossSolveDefinition = {
...
export const assetDisposalSolveDefinition = {
...
export const productionBudgetSolveDefinition = {
...
export const salesBudgetSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        if (![budgetedSalesUnits, sellingPricePerUnit, budgetedSalesAmount].every(Number.isFinite) ||
        ...
        return {
            primaryResult: {
                title: targetKey === "budgetedSalesUnits"
                    ? "Budgeted Unit Sales"
                    : targetKey === "sellingPricePerUnit"
                        ? "Selling Price / Unit"
                        : "Budgeted Sales Revenue",
                value: targetKey === "budgetedSalesUnits"
...
export const directMaterialsPurchasesBudgetSolveDefinition = {
...
export const directLaborBudgetSolveDefinition = {
...
export const factoryOverheadBudgetSolveDefinition = {
...
export const budgetedIncomeStatementSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "grossProfit")
            return ["budgetedSalesAmount", "budgetedCostOfGoodsSold"];
...
export const specialOrderDecisionSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "minimumAcceptablePricePerUnit"
                    ? "Minimum Acceptable Price / Unit"
                    : targetKey === "incrementalRevenue"
                        ? "Incremental Revenue"
                        : "Incremental Profit",
                value: targetKey === "minimumAcceptablePricePerUnit"
...
export const makeOrBuyDecisionSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            ...
            interpretation: computed.preferredOption === "Indifferent"
...
export const sellProcessFurtherSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "incrementalRevenueFromProcessing"
                    ? "Incremental Revenue"
                    : targetKey === "minimumFurtherProcessingPricePerUnit"
                        ? "Minimum After-Processing Price / Unit"
                        : "Incremental Profit",
                value: targetKey === "incrementalRevenueFromProcessing"
...
export const constrainedResourceProductMixSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "maximumUnitsFromConstraint"
                ...
                value: targetKey === "maximumUnitsFromConstraint"
            ...
            interpretation: "Use the contribution margin per scarce-resource unit to rank competing products before using raw unit margin alone.",
            assumptions: [
...
export const budgetVarianceAnalysisSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "spendingVariance"
                    ? "Spending Variance"
                    : targetKey === "activityVariance"
                        ? "Activity Variance"
                        : "Total Variance",
                value: targetKey === "spendingVariance"
            ...
            interpretation: "This view helps separate execution performance from the effect of operating at a different activity level than the static plan assumed.",
        };
    },
};
export const movingAverageForecastSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "simpleMovingAverageForecast"
                    ? "Simple Moving Average Forecast"
                    : "Weighted Moving Average Forecast",
                value: targetKey === "simpleMovingAverageForecast"
            ...
            interpretation: "Use the weighted version when recent periods deserve more influence than older demand observations.",
            assumptions: [
...
export const intercompanyInventoryProfitSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        const eliminationRate = (markupRateOnCostPercent / 100) /
        ...
        if (![transferPrice, unrealizedProfitInEndingInventory].every(Number.isFinite) ||
            transferPrice < 0 ||
        ...
        return {
            primaryResult: {
                title: targetKey === "transferPrice"
                    ? "Intercompany Transfer Price"
                    : "Unrealized Profit in Ending Inventory",
                value: targetKey === "transferPrice"
...
export const notesReceivableDiscountingSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "maturityValue")
            return ["faceValue", "statedRate", "time"];
...
export const equityMethodInvestmentSolveDefinition = {
...
export const intercompanyPpeTransferSolveDefinition = {
...
export const vatReconciliationSolveDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title: targetKey === "taxableSalesAmount"
                    ? "Taxable Sales"
                    : "Net VAT Payable",
                value: targetKey === "taxableSalesAmount"
                    ? formatPHP(taxableSalesAmount)
                    : formatPHP(computed.netVatPayable),
                tone: computed.remittancePosition === "payable"
                    ? "accent"
            ...
            interpretation: computed.remittancePosition === "payable"
            ...
            assumptions: buildTaxAssumptionNotes(PHILIPPINE_TAX_ASSUMPTIONS.vat, ["This classroom helper assumes one VAT rate across the entered taxable sales and vatable purchases and does not replace full legal classification of zero-rated, exempt, or specially treated items."]),
            warnings: [
...
export const withholdingTaxSolveDefinition = {
    ...
    getInputKeys(targetKey) {
        if (targetKey === "taxBase")
            return ["taxWithheld", "ratePercent"];
        if (targetKey === "ratePercent")
            return ["taxBase", "taxWithheld"];
    ...
    solve(targetKey, values) {
        ...
        if (targetKey === "taxBase") {
            if (ratePercent <= 0)
                return { error: "Rate must be greater than zero when solving for the tax base." };
            taxBase = taxWithheld / (ratePercent / 100);
        }
        else if (targetKey === "ratePercent") {
            if (taxBase <= 0)
                return { error: "Tax base must be greater than zero when solving for the rate." };
        ...
        return {
            primaryResult: {
                title: targetKey === "taxBase"
                    ? "Tax Base"
                    : targetKey === "ratePercent"
                        ? "Rate"
                        : "Tax Withheld",
                value: targetKey === "taxBase"
                    ? formatPHP(taxBase)
                    : targetKey === "ratePercent"
                        ? formatPercent(ratePercent)
