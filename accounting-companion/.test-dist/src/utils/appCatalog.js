...
export function getRouteMeta(path) {
    ...
    if (studyTopic) {
        return {
            ...
            offlineSupport: "full",
            offlineSummary: "Topic lessons, explanations, and quiz links stay available offline after the current release is cached.",
            offlineDetail: "Study Hub lessons and practice links are browser-local after caching, with bookmarks, notes, and progress stored on this device.",
            isNew: true,
        };
    }
    ...
    if (studyQuizTopic) {
        return {
            ...
            offlineSupport: "full",
            offlineSummary: "Topic quizzes and answer explanations remain available offline after the current release is cached.",
            offlineDetail: "Practice mode runs locally in the browser, with attempts and scores saved on this device without a backend account.",
            isNew: true,
        };
    }
    return null;
