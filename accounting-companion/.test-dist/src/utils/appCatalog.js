...
const CURRENT_RELEASE_NEW_PATHS = new Set([
    "/far/provision-expected-value",
    "/afar/franchise-revenue-workspace",
    "/accounting/dupont-analysis",
    "/accounting/earnings-quality-analysis",
    "/statistics/confidence-interval",
    "/operations/retail-markup-markdown",
    "/finance/capital-rationing-prioritizer",
]);
...
export const APP_ROUTE_META = [
    ...
    feature("/finance/capital-rationing-prioritizer", "Capital Rationing Prioritizer", "Finance", "Rank capital projects by profitability index and choose a budget-limited project set with transparent assumptions.", ["capital rationing", "project prioritization", "profitability index ranking", "investment budget constraint"], ["capital budgeting", "management services", "project selection"], "Rationing", true, ["capital rationing", "profitability index", "project selection", "budget constraint"]),
    ...
    feature("/statistics/confidence-interval", "Confidence Interval Helper", "Statistics", "Build a transparent large-sample confidence interval for analytics, audit sampling, forecasting, and marketing-research estimates.", ["confidence interval", "margin of error", "standard error", "sampling estimate"], ["statistics", "analytics", "sampling"], "CI", true, ["confidence interval", "margin of error", "standard error", "sample mean", "audit sampling"]),
