...
const CURRENT_RELEASE_NEW_PATHS = new Set([
    ...
    "/afar/installment-sales-review",
    "/audit/going-concern-review",
    "/tax/tax-remedy-timeline-review",
    "/ais/incident-response-triage",
    ...
    "/tax/income-tax-payable-review",
    "/ais/revenue-cycle-control-review",
    "/governance/fraud-risk-response-planner",
    "/rfbt/negotiable-instruments-issue-spotter",
    ...
    "/business/segmented-income-statement",
    "/audit/audit-sampling-planner",
    "/operations/pert-project-estimate",
    "/far/quasi-reorganization",
    "/far/financial-asset-amortized-cost",
    "/far/investment-property-measurement",
    "/afar/corporate-liquidation",
    "/afar/joint-arrangement-analyzer",
    "/business/activity-based-costing",
    "/operations/quality-control-chart",
    "/rfbt/obligations-contracts-flow",
    "/ais/access-control-review",
]);
...
export const APP_ROUTE_META: RouteMeta[] = [
    ...
    feature("/accounting/dupont-analysis", "DuPont ROE Analyzer", "Accounting", "Decompose ROE into profit margin, asset turnover, and leverage so statement-analysis cases explain the source of return changes.", ["dupont analysis", "dupont roe", "return on equity decomposition", "roe breakdown"], ["ratios", "analysis", "financial statement analysis"], "DuPont", true, ["dupont", "roe", "profit margin", "asset turnover", "equity multiplier"]),
    feature("/accounting/earnings-quality-analysis", "Earnings Quality and Accruals Analyzer", "Accounting", "Compare net income with operating cash flow to flag accrual pressure and earnings-quality review needs.", ["earnings quality", "accrual ratio", "cash conversion of income", "quality of earnings"], ["analysis", "cash flows", "earnings quality"], "Earnings Quality", true, ["earnings quality", "accruals", "operating cash flow", "cash conversion"]),
    ...
    feature("/finance/capital-rationing-prioritizer", "Capital Rationing Prioritizer", "Finance", "Compare profitability-index ranking with an exact constrained-budget project-combination search.", ["capital rationing", "project prioritization", "profitability index ranking", "investment budget constraint"], ["capital budgeting", "management services", "project selection"], "Rationing", true, ["capital rationing", "profitability index", "project selection", "budget constraint", "project combination"]),
    ...
    feature("/business/transfer-pricing-support", "Transfer Pricing Support", "Managerial & Cost", "Compare minimum transfer price, market-based ceiling, and negotiation range for divisional transfer-pricing cases.", ["transfer pricing", "minimum transfer price", "market based transfer price", "divisional transfer price"], ["performance management", "managerial", "transfer pricing"], "Transfer Pricing", true, ["transfer pricing", "minimum transfer price", "opportunity cost", "market-based ceiling", "divisional pricing"]),
    feature("/business/activity-based-costing", "Activity-Based Costing Allocator", "Managerial & Cost", "Allocate activity cost pools using driver rates and compute product-level overhead, total cost, and unit product cost.", ["abc costing", "activity based costing", "cost pool driver", "activity rate"], ["abc", "overhead", "cost drivers"], "ABC", true, ["activity based costing", "activity rate", "cost pool", "cost driver", "overhead allocation"]),
    ...
    feature("/business/sales-volume-variance", "Sales Volume Variance", "Managerial & Cost", "Compare actual and budgeted sales volume using the budgeted contribution margin per unit.", ["sales quantity variance", "sales volume effect", "sales volume variance"], ["variance", "sales mix", "managerial"], "Sales Vol", true, ["sales volume variance", "sales quantity variance", "budgeted contribution margin"]),
    feature("/business/sales-mix-variance", "Sales Mix Variance", "Managerial & Cost", "Measure the favorable or unfavorable effect of actual product mix versus the budgeted sales mix.", ["mix variance", "sales mix effect", "sales mix variance"], ["variance", "sales mix", "managerial"], "Sales Mix", true, ["sales mix variance", "actual mix", "budgeted mix", "product mix variance"]),
    ...
    feature("/business/segmented-income-statement", "Segmented Income Statement Analyzer", "Managerial & Cost", "Compute contribution margin, traceable segment margin, allocated common-cost effect, and responsibility-accounting interpretation.", ["segmented income statement", "segment margin", "traceable fixed costs", "responsibility accounting"], ["performance", "responsibility accounting", "segment reporting"], "Segment Margin", true, ["segment margin", "segmented income statement", "traceable fixed costs", "common fixed costs"]),
    ...
    feature("/operations/pert-project-estimate", "PERT Project Estimate Helper", "Managerial & Cost", "Estimate expected project time, standard deviation, and variance from optimistic, most-likely, and pessimistic activity estimates.", ["pert estimate", "project management estimate", "optimistic most likely pessimistic", "project scheduling"], ["operations", "project management", "scheduling"], "PERT", true, ["pert", "project estimate", "optimistic", "most likely", "pessimistic"]),
    feature("/operations/quality-control-chart", "Quality Control Chart Helper", "Managerial & Cost", "Build three-sigma control limits and flag out-of-control observations for operations and quality-control review.", ["quality control chart", "control limits", "statistical quality control", "three sigma"], ["operations", "quality", "statistics"], "SQC", true, ["quality control", "control chart", "ucl", "lcl", "three sigma", "statistical quality control"]),
    feature("/operations/safety-stock-planner", "Safety Stock Planner", "Managerial & Cost", "Estimate safety stock and reorder point from average and worst-case usage plus lead-time assumptions.", ["buffer stock planner", "reorder level planner", "safety stock"], ["operations", "inventory planning", "supply chain"], "Safety Stock", true, ["safety stock", "buffer stock", "reorder point", "lead time"]),
    feature("/operations/cost-plus-pricing", "Cost-Plus Pricing Planner", "Managerial & Cost", "Translate unit cost and target margin into a suggested price, markup, and unit volume needed for target income.", ["cost plus pricing", "pricing planner", "markup pricing"], ["operations", "pricing", "costing"], "Pricing", true, ["cost plus pricing", "markup pricing", "pricing planner", "target margin", "costing and pricing"]),
    feature("/operations/retail-markup-markdown", "Retail Markup and Markdown Planner", "Managerial & Cost", "Connect retail pricing, cost, markdowns, maintained margin, sales revenue, and gross profit in one planning worksheet.", ["retail markup", "markdown planner", "maintained margin", "retail pricing"], ["operations", "pricing", "retail"], "Retail Pricing", true, ["retail markup", "markdown", "maintained margin", "gross margin", "retail management"]),
    feature("/far/dividend-allocation", "Dividend Allocation", "Accounting", "Allocate declared dividends between preferred and common shares, including preferred arrears when relevant.", ["preferred common dividend allocation", "dividend arrears allocation", "dividend allocation"], ["far", "equity", "dividends"], "Dividends", true, ["dividend allocation", "preferred dividends", "dividends in arrears", "common dividend per share"]),
    feature("/far/conceptual-framework-recognition", "Conceptual Framework Recognition Helper", "Accounting", "Classify financial statement elements, test recognition support, and choose a measurement-basis explanation before computation.", ["conceptual framework", "recognition criteria", "measurement basis"], ["far", "conceptual framework", "recognition", "measurement"], "Framework", true, ["conceptual framework", "recognition", "asset definition", "liability definition", "measurement basis", "disclosure"]),
    feature("/far/revenue-allocation-workspace", "Revenue Allocation Workspace", "Accounting", "Allocate bundled consideration to two performance obligations and read revenue, contract asset, or contract liability effects.", ["revenue recognition", "transaction price allocation", "performance obligation"], ["far", "revenue", "allocation", "contract liability"], "Revenue", true, ["revenue allocation", "performance obligation", "standalone selling price", "contract asset", "contract liability"]),
    ...
    feature("/far/borrowing-costs-capitalization", "Borrowing Costs Capitalization", "Accounting", "Estimate avoidable borrowing cost on qualifying-asset expenditures over the capitalization period.", ["borrowing costs", "avoidable interest", "capitalized interest"], ["far", "assets", "measurement"], "Borrowing Cost", true, ["borrowing costs", "avoidable interest", "capitalized interest", "qualifying asset"]),
    feature("/far/provision-expected-value", "Provision Expected Value Planner", "Accounting", "Estimate a probability-weighted provision and document the recognition and disclosure caution for uncertain obligations.", ["provisions", "contingencies", "expected value provision", "probability weighted liability"], ["far", "liabilities", "contingencies"], "Provisions", true, ["provision", "contingency", "expected value", "probability weighted"]),
    feature("/far/quasi-reorganization", "Quasi-Reorganization Deficit Cleanup", "Accounting", "Model deficit relief from share premium, revaluation surplus, and capital reduction so quasi-reorganization assumptions stay visible.", ["quasi reorganization", "deficit cleanup", "capital reduction", "clean surplus"], ["far", "equity", "deficit"], "Quasi-Reorg", true, ["quasi-reorganization", "deficit", "capital reduction", "share premium"]),
    feature("/far/financial-asset-amortized-cost", "Financial Asset Amortized Cost Schedule", "Accounting", "Compute effective-interest revenue, cash interest, amortization, ending gross carrying amount, and ECL-adjusted net carrying amount.", ["financial asset amortized cost", "effective interest asset", "debt investment amortization", "expected credit loss"], ["far", "financial assets", "effective interest"], "Fin Asset", true, ["financial asset", "amortized cost", "effective interest", "expected credit loss", "debt investment"]),
    feature("/far/investment-property-measurement", "Investment Property Measurement Helper", "Accounting", "Compare fair value model gain or loss with cost-model carrying amount after depreciation and impairment assumptions.", ["investment property", "fair value model", "cost model investment property"], ["far", "investment property", "measurement"], "Inv Property", true, ["investment property", "fair value model", "cost model", "depreciation", "impairment"]),
    ...
    feature("/audit/audit-sampling-planner", "Audit Sampling Planner", "Accounting", "Estimate sample size, sampling interval, and allowance for sampling risk using transparent classroom assumptions.", ["audit sampling", "monetary unit sampling", "sample size", "tolerable misstatement"], ["audit", "sampling", "evidence"], "Sampling", true, ["audit sampling", "sample size", "sampling interval", "tolerable misstatement", "expected misstatement"]),
    feature("/audit/misstatement-evaluation-workspace", "Audit Misstatement Evaluation Workspace", "Accounting", "Evaluate projected plus allowance misstatement against tolerable misstatement while keeping clearly trivial and qualitative pressure visible.", ["projected misstatement", "allowance for sampling risk", "misstatement evaluation"], ["audit", "sampling", "completion"], "Misstatement", true, ["projected misstatement", "tolerable misstatement", "allowance for sampling risk", "clearly trivial", "audit completion"]),
    ...
    feature("/audit/assertion-evidence-planner", "Audit Assertion and Evidence Planner", "Accounting", "Map audit assertions into the evidence response, procedure emphasis, and working-paper story that best fits the risk.", ["audit assertions", "audit evidence planner", "evidence response"], ["audit", "assertions", "evidence"], "Assertions", true, ["audit assertion", "occurrence completeness valuation", "audit evidence", "working paper planning"]),
    feature("/audit/evidence-program-builder", "Audit Evidence Program Builder", "Accounting", "Score assertion risk against evidence reliability, relevance, coverage, and contradictions to plan stronger audit procedures.", ["audit evidence program", "evidence sufficiency", "audit procedure builder"], ["audit", "evidence", "assertions", "procedures"], "Evidence", true, ["audit evidence", "sufficient appropriate evidence", "reliability", "relevance", "contradictory evidence", "substantive procedures"]),
    feature("/audit/materiality-and-misstatement-planner", "Audit Materiality and Misstatement Planner", "Accounting", "Plan materiality thresholds, clearly trivial amounts, and misstatement pressure for audit planning and completion review.", ["audit materiality planner", "performance materiality", "clearly trivial", "misstatement cushion"], ["audit", "materiality", "misstatement", "planning"], "Materiality", true, ["planning materiality", "performance materiality", "clearly trivial", "uncorrected misstatement", "tolerable misstatement"]),
    feature("/audit/going-concern-review", "Going Concern Review Workspace", "Accounting", "Score adverse conditions against management plans and evidence support to guide going-concern procedures and reporting review.", ["going concern", "substantial doubt", "management plans", "audit completion"], ["audit", "completion", "going concern"], "Going Concern", true, ["going concern", "substantial doubt", "liquidity pressure", "management plan", "subsequent events"]),
    feature("/audit/analytical-procedures-review", "Analytical Procedures Review", "Accounting", "Compare prior, current, and expected amounts to flag unexplained differences and follow-up procedure needs.", ["analytical procedures", "audit analytics", "unexpected fluctuation"], ["audit", "analytics", "procedures"], "Analytical Review", true, ["analytical procedures", "expectation", "tolerable difference", "unexplained difference", "risk assessment"]),
    ...
    feature("/tax/taxable-income-bridge", "Taxable Income Bridge", "Accounting", "Bridge accounting income to taxable income with permanent items, temporary differences, loss deductions, current tax, and deferred-tax signals.", ["income taxation", "taxable income", "income tax bridge"], ["tax", "income tax", "deferred tax", "compliance"], "Taxable Income", true, ["taxable income", "income tax", "permanent difference", "temporary difference", "deferred tax", "nolco"]),
    feature("/tax/income-tax-payable-review", "Income Tax Payable and Credits Review", "Accounting", "Reconcile taxable income, gross tax due, withholding credits, payments, refundable credits, and penalties into a payable or overpayment signal.", ["income tax payable", "tax credits", "tax payments", "tax overpayment"], ["tax", "income tax", "compliance", "credits"], "Tax Payable", true, ["income tax payable", "withholding credits", "quarterly payments", "tax overpayment", "tax refund", "tax credits"]),
    feature("/tax/tax-remedy-timeline-review", "Tax Remedy Timeline Review", "Accounting", "Triage educational tax-remedy cases by entered deadline pressure, evidence completeness, materiality, and procedural complexity.", ["tax remedies", "tax protest", "refund claim", "assessment deadline"], ["tax", "remedies", "compliance"], "Tax Remedies", true, ["tax remedy", "tax protest", "refund", "assessment", "deadline", "evidence"]),
    feature("/tax/deduction-substantiation-review", "Deduction Substantiation Review", "Accounting", "Separate claimed deductions, disallowed items, documentation support, taxable income, and tax effect of unsupported items.", ["deductible expenses", "substantiation", "allowable deductions", "tax deductions"], ["tax", "deductions", "income tax"], "Deductions", true, ["deductions", "substantiation", "ordinary necessary", "disallowed items", "taxable income"]),
    ...
    feature("/tax/estate-tax-helper", "Estate Tax Helper", "Accounting", "Estimate net estate and estate tax due with visible classroom-rate assumptions and deduction support.", ["estate tax", "net estate", "estate tax due"], ["tax", "transfer tax", "philippines"], "Estate Tax", true, ["estate tax", "gross estate", "net estate", "allowable deductions"]),
    feature("/tax/donors-tax-helper", "Donor's Tax Helper", "Accounting", "Estimate taxable gift and donor's tax due using visible classroom-rate assumptions.", ["donors tax", "donor's tax", "gift tax"], ["tax", "transfer tax", "philippines"], "Donor Tax", true, ["donor's tax", "donors tax", "gift tax", "taxable gift"]),
    feature("/tax/documentary-stamp-tax-helper", "Documentary Stamp Tax Helper", "Accounting", "Compute DST due from a taxable base, taxable unit size, and rate per unit with assumption notes kept visible.", ["documentary stamp tax", "dst", "stamp tax"], ["tax", "transfer tax", "philippines"], "DST", true, ["documentary stamp tax", "dst", "stamp tax", "rate per unit"]),
    ...
    feature("/tax/excise-local-and-incentive-review", "Excise, Local Tax, and Incentive Review", "Accounting", "Review excise-tax framing, local-tax exposure, incentive regimes, treaty posture, and remedy logic from one tax-support workspace.", ["excise tax review", "local taxation review", "tax incentives review"], ["tax", "compliance", "special taxes"], "Tax Depth", true, ["excise tax", "local taxation", "peza", "boi", "bcda", "bmbe", "tax remedies", "tax treaty"]),
    ...
    feature("/afar/consignment-settlement", "Consignment Settlement", "Accounting", "Compute consignee commission, settlement deductions, and the balance still due to the consignor.", ["consignee settlement", "consignment accounting", "cash due consignor"], ["afar", "consignment", "special topics"], "Consignment", true, ["consignment", "consignee commission", "cash due to consignor", "settlement"]),
    feature("/afar/branch-inventory-loading", "Branch Inventory Loading", "Accounting", "Convert branch inventory at billed price into loading allowance and inventory at cost for branch-home-office review.", ["branch inventory loading", "allowance for overvaluation", "branch loading"], ["afar", "branch accounting", "inventory"], "Branch Load", true, ["branch inventory", "loading on cost", "allowance for overvaluation", "inventory at billed price"]),
    ...
    feature("/afar/franchise-revenue-workspace", "Franchise Revenue Workspace", "Accounting", "Analyze an initial franchise fee by separating satisfied performance obligations, collectability pressure, and remaining contract liability.", ["franchise accounting", "initial franchise fee", "franchise revenue recognition"], ["afar", "revenue", "franchise"], "Franchise", true, ["franchise accounting", "initial franchise fee", "performance obligation", "contract liability"]),
    feature("/afar/installment-sales-review", "Installment Sales Gross Profit Review", "Accounting", "Review gross profit rate, realized gross profit from collections, deferred gross profit, and repossession recovery signals.", ["installment sales", "deferred gross profit", "realized gross profit", "repossession"], ["afar", "revenue", "special sales"], "Installment Sales", true, ["installment sales", "gross profit rate", "deferred gross profit", "cash collections", "repossession"]),
    feature("/afar/corporate-liquidation", "Corporate Liquidation Recovery Planner", "Accounting", "Estimate net estate available, unsecured creditor recovery, and deficiency in corporate liquidation or statement-of-affairs review.", ["corporate liquidation", "statement of affairs", "unsecured recovery", "realization and liquidation"], ["afar", "liquidation", "special topics"], "Corp Liquid", true, ["corporate liquidation", "statement of affairs", "unsecured creditors", "liquidation costs"]),
    feature("/afar/joint-arrangement-analyzer", "Joint Arrangement Share Analyzer", "Accounting", "Estimate a venturer's share of assets, liabilities, revenue, expenses, profit, and net position with classification cautions.", ["joint arrangement", "joint operation", "joint venture", "share of assets"], ["afar", "joint arrangements", "special topics"], "Joint Arr.", true, ["joint arrangement", "joint operation", "joint venture", "share of profit", "rights to assets"]),
    ...
    feature("/ais/enterprise-systems-control-mapper", "Enterprise Systems and Control Mapper", "Accounting", "Review ERP, SCM, CRM, and BI environments through access, change, interface, and documentation-control lenses.", ["erp controls", "crm controls", "supply chain system controls"], ["ais", "systems", "controls"], "Systems Map", true, ["erp", "scm", "crm", "business intelligence", "interface controls", "systems documentation"]),
    feature("/ais/access-control-review", "Access Control Review Workspace", "Accounting", "Score logical access, privileged access, change risk, monitoring, and evidence needs for AIS and IT-audit cases.", ["logical access", "privileged access", "segregation of duties", "access control review"], ["ais", "it controls", "access"], "Access", true, ["logical access", "privileged access", "segregation of duties", "periodic access review"]),
    feature("/ais/segregation-of-duties-conflict-matrix", "Segregation of Duties Conflict Matrix", "Accounting", "Score incompatible-duty conflicts and compensating review strength so AIS and IT-audit role-overlap cases stay structured.", ["segregation of duties matrix", "sod conflict", "incompatible duties"], ["ais", "controls", "access"], "SoD Matrix", true, ["segregation of duties", "incompatible duties", "role overlap", "compensating review", "privileged access"]),
    feature("/ais/business-continuity-planner", "Business Continuity Planner", "Accounting", "Score backup, incident-response, vendor, and communications readiness while comparing expected recovery with the target RTO.", ["business continuity planner", "recovery time objective", "continuity readiness"], ["ais", "continuity", "resilience"], "Continuity", true, ["business continuity", "disaster recovery", "recovery time objective", "incident response", "vendor resilience"]),
    feature("/ais/revenue-cycle-control-review", "Revenue Cycle Control Review", "Accounting", "Map order-to-cash controls to revenue-cycle assertions, walkthrough evidence, weak control gaps, and audit follow-up.", ["revenue cycle controls", "sales cycle controls", "order to cash controls"], ["ais", "controls", "revenue cycle", "audit"], "Revenue Cycle", true, ["revenue cycle", "order to cash", "sales order approval", "invoice sequence", "cash application", "exception report"]),
    feature("/ais/incident-response-triage", "Incident Response Triage", "Accounting", "Score confidentiality, integrity, and availability impact against containment and evidence readiness for AIS incident review.", ["incident response", "security incident", "cia triad", "it audit incident"], ["ais", "controls", "security"], "Incident Triage", true, ["incident response", "confidentiality", "integrity", "availability", "containment", "evidence"]),
    ...
    feature("/governance/control-environment-review", "Control Environment Review", "Accounting", "Evaluate oversight, ethics, competence, accountability, and escalation readiness in governance and internal-control cases.", ["control environment review", "tone at the top", "ethical escalation"], ["governance", "ethics", "control"], "Control Env.", true, ["control environment", "good governance", "management override", "escalation", "tone at the top"]),
    feature("/governance/ethics-decision-workspace", "Ethics Decision Workspace", "Accounting", "Structure ethics cases around pressure, stakeholder impact, override risk, and escalation logic.", ["ethics decision workspace", "ethical pressure review", "governance ethics"], ["governance", "ethics", "risk"], "Ethics", true, ["business ethics", "decision ethics", "management override", "stakeholder impact", "ethical pressure"]),
    feature("/governance/governance-escalation-planner", "Governance Escalation Planner", "Accounting", "Translate issue severity, override risk, stakeholder exposure, and oversight readiness into a clearer escalation tier.", ["governance escalation", "audit committee escalation", "override escalation"], ["governance", "ethics", "escalation"], "Escalation", true, ["governance escalation", "audit committee", "board escalation", "stakeholder exposure", "override risk"]),
    feature("/governance/fraud-risk-response-planner", "Fraud Risk Response Planner", "Accounting", "Convert fraud-triangle, management-override, and evidence-quality signals into audit, governance, and ethics response steps.", ["fraud risk response", "fraud triangle", "management override", "professional skepticism"], ["governance", "audit", "ethics", "fraud"], "Fraud Risk", true, ["fraud risk", "fraud triangle", "management override", "professional skepticism", "audit committee", "journal entry testing"]),
    ...
    feature("/rfbt/obligations-contracts-flow", "Obligations and Contracts Issue Flow", "Accounting", "Classify obligations, contract defects, remedies, and review next steps for RFBT issue-spotting problems.", ["obligations", "contracts", "defective contracts", "voidable unenforceable void"], ["rfbt", "contracts", "review"], "Obligations", true, ["obligations", "contracts", "defective contracts", "damages", "remedies"]),
    feature("/rfbt/negotiable-instruments-issue-spotter", "Negotiable Instruments Issue Spotter", "Accounting", "Classify holder status, defenses, party liability, presentment, dishonor, and notice issues for commercial-law review.", ["negotiable instruments", "holder in due course", "dishonor notice", "commercial paper"], ["rfbt", "commercial law", "negotiable instruments"], "Negotiable", true, ["negotiable instruments", "holder in due course", "personal defense", "real defense", "presentment", "dishonor", "notice of dishonor"]),
    feature("/rfbt/security-contracts-remedy-review", "Security Contracts Remedy Review", "Accounting", "Review collateral coverage, priority claims, remedy costs, documentation strength, default severity, and deficiency exposure.", ["security contracts", "pledge mortgage guaranty", "credit transactions", "collateral remedy"], ["rfbt", "credit transactions", "remedies"], "Security Remedy", true, ["security contract", "credit transactions", "collateral", "deficiency", "priority claims", "remedy"]),
    feature("/rfbt/defective-contracts-classifier", "Defective Contracts Classifier", "Accounting", "Classify void, voidable, unenforceable, and rescissible contracts while keeping remedy and enforceability logic visible.", ["defective contracts classifier", "voidable contract", "rescissible contract"], ["rfbt", "contracts", "remedies"], "Defects", true, ["defective contracts", "voidable", "unenforceable", "void contract", "rescissible", "annulment", "ratification"]),
    ...
    feature("/rfbt/securities-and-governance-review", "Securities and Corporate Governance Review", "Accounting", "Review securities regulation, fiduciary duties, insider trading, restructuring, and governance consequences from one RFBT workspace.", ["securities regulation review", "corporate governance review", "insider trading review"], ["rfbt", "governance", "securities"], "Securities", true, ["securities", "insider trading", "market manipulation", "corporate governance", "merger", "rehabilitation", "liquidation"]),
    ...
    feature("/strategic/business-case-analysis", "Business Case Analysis Planner", "Accounting", "Blend market, cost, control, execution, and risk signals into a go, refine, or stop recommendation for strategic cases.", ["business case analysis", "go no-go analysis", "consultancy recommendation"], ["strategic", "analysis", "planning"], "Business Case", true, ["business case", "go no-go", "market attractiveness", "execution readiness", "risk penalty"]),
    feature("/strategic/balanced-scorecard-workspace", "Balanced Scorecard Workspace", "Accounting", "Map strategy into financial, customer, process, and learning signals so performance stories stay integrated.", ["balanced scorecard", "strategic performance map", "strategy map"], ["strategic", "performance", "integration"], "Scorecard", true, ["balanced scorecard", "strategy map", "financial perspective", "customer perspective", "learning and growth"]),
    feature("/strategic/target-costing-workspace", "Target Costing Workspace", "Accounting", "Convert market price and target profit into allowable cost, revised estimated cost, and remaining cost gap.", ["target costing", "allowable cost", "cost gap"], ["strategic", "pricing", "target costing"], "Target Cost", true, ["target costing", "allowable cost", "target profit", "cost gap", "kaizen costing"]),
    feature("/strategic/cpa-integrated-review-studio", "CPA Integrated Review Studio", "Accounting", "Score mixed-review attempts across route choice, computation, explanation, assumptions, and follow-up completion.", ["cpa mixed review", "integrated review", "case practice", "topic routing"], ["strategic", "integrated review", "study"], "CPA Review", true, ["integrated review", "mixed practice", "topic identification", "case routing", "cpa review", "study plan"]),
    ...
    feature("/statistics/confidence-interval", "Confidence Interval Helper", "Statistics", "Build transparent z or t confidence intervals for analytics, audit sampling, forecasting, and marketing-research estimates.", ["confidence interval", "margin of error", "standard error", "sampling estimate", "t interval", "z interval"], ["statistics", "analytics", "sampling"], "CI", true, ["confidence interval", "margin of error", "standard error", "sample mean", "audit sampling", "t critical", "z critical"]),
