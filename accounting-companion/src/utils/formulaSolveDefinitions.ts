...
import {
    ...
    computeDividendAllocation,
    computeDocumentaryStampTax,
    computeDonorsTax,
    ...
    computeSalesBudget,
    computeSalesMixVariance,
    computeSalesVolumeVariance,
    computeSafetyStockPlanner,
    ...
    computeConsignmentSettlement,
    computeBranchInventoryLoading,
...
export const transferPricingSupportSolveDefinition: FormulaCalculatorDefinition = {
...
export const salesVolumeVarianceSolveDefinition: FormulaCalculatorDefinition = {
...
export const salesMixVarianceSolveDefinition: FormulaCalculatorDefinition = {
...
export const safetyStockPlannerSolveDefinition: FormulaCalculatorDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                ...
                value: formatPlain(
                    targetKey === "safetyStock" ? computed.safetyStock : computed.reorderPoint
                ),
                tone: "accent",
            },
            supportingResults: [
...
export const estateTaxSolveDefinition: FormulaCalculatorDefinition = {
    id: "estate-tax-solve",
    ...
    solve(targetKey, values) {
        ...
        return {
            ...
            assumptions: buildTaxAssumptionNotes(
                PHILIPPINE_TAX_ASSUMPTIONS.estateTax,
                ["This helper assumes the scenario already identified the taxable estate base correctly."]
            ),
        };
    },
};

export const donorsTaxSolveDefinition: FormulaCalculatorDefinition = {
    id: "donors-tax-solve",
    ...
    solve(targetKey, values) {
        ...
        return {
            ...
            assumptions: buildTaxAssumptionNotes(
                PHILIPPINE_TAX_ASSUMPTIONS.donorsTax,
                ["This helper keeps the arithmetic visible but does not replace legal classification of exemptions or exclusions."]
            ),
        };
    },
};

export const documentaryStampTaxSolveDefinition: FormulaCalculatorDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            ...
            assumptions: buildTaxAssumptionNotes(
                PHILIPPINE_TAX_ASSUMPTIONS.documentaryStampTax,
                ["This helper assumes the applicable taxable unit and per-unit rate have already been identified from the scenario or tax reference."]
            ),
        };
    },
};

export const consignmentSettlementSolveDefinition: FormulaCalculatorDefinition = {
...
export const branchInventoryLoadingSolveDefinition: FormulaCalculatorDefinition = {
...
export const dividendAllocationSolveDefinition: FormulaCalculatorDefinition = {
    ...
    solve(targetKey, values) {
        ...
        return {
            primaryResult: {
                title:
                    targetKey === "preferredDividendAllocated"
