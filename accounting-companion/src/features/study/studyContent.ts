...
import { STUDY_HUB_EXPANSION_1330_TOPICS } from "./studyExpansion1330.js";
import { STUDY_HUB_EXPANSION_1340_TOPICS } from "./studyExpansion1340.js";
...
const STUDY_TOPICS: StudyTopic[] = [
    ...
    ...STUDY_HUB_EXPANSION_1330_TOPICS,
    ...STUDY_HUB_EXPANSION_1340_TOPICS,
];
...
export function getStudyTopicsByTrack(track: string) {
    return STUDY_TOPICS.filter((topic) => getStudyCategoryTrack(topic.category) === track);
}

export function getAdjacentStudyTopics(topicId: string) {
