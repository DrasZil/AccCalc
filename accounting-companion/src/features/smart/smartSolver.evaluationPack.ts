...
export const SMART_SOLVER_EVALUATION_PACK: SmartSolverEvaluationCase[] = [
    ...
    },
    {
        ...
        level: "L2",
        prompt:
            "Our audit case shows tolerable misstatement of 250000, projected misstatement of 180000, allowance for sampling risk of 45000, clearly trivial threshold of 10000, and several qualitative concerns. Which audit route fits best?",
    ...
    },
    {
        ...
        level: "L2",
        prompt:
            "Evaluate segregation of duties when the same user can authorize purchases, record supplier invoices, and maintain privileged access while compensating review is weak.",
    ...
    },
    {
        ...
        level: "L2",
        prompt:
            "Management override risk is high, stakeholder exposure is high, documentation is weak, and the issue may need audit committee escalation. What governance tool should I open?",
