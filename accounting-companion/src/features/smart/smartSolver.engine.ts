...
import {
    ...
    export const CALCULATORS: CalculatorConfig[] = [
    {
        ...
        description:
        "Best when the prompt asks whether an item is an asset, liability, income, expense, disclosure issue, or measurement-basis question.",
        required: [],
    ...
    },
    {
        ...
        description:
        "Best when the prompt gives a bundled contract, standalone selling prices, performance obligations, or contract asset/liability facts.",
        required: [],
    ...
    },
    {
        ...
        description:
        "Best when the prompt asks for taxable income from accounting income using permanent or temporary differences.",
        required: [],
    ...
    },
    {
        ...
        description:
        "Best when the prompt asks about audit evidence sufficiency, reliability, relevance, contradictions, or procedure intensity.",
        required: [],
    ...
    {
        id: "installment-sales-review",
        name: "Installment Sales Gross Profit Review",
        route: "/afar/installment-sales-review",
        description:
        "Best when the prompt asks for gross profit rate, realized gross profit, deferred gross profit, installment collections, or repossession review.",
        required: [],
        aliases: ["installment sales", "deferred gross profit", "realized gross profit"],
        keywords: [
        /installment sales/i,
        /deferred gross profit/i,
        /realized gross profit/i,
        /gross profit rate/i,
        /cash collections/i,
        /repossession/i,
        ],
    ...
    {
        id: "going-concern-review",
        name: "Going Concern Review Workspace",
        route: "/audit/going-concern-review",
        description:
        "Best when the prompt asks about substantial doubt, liquidity pressure, management plans, subsequent events, or going-concern audit procedures.",
        required: [],
        aliases: ["going concern", "substantial doubt", "management plans"],
        keywords: [
        /going concern/i,
        /substantial doubt/i,
        /liquidity pressure/i,
        /management plan/i,
        /recurring losses/i,
        /debt covenant/i,
        ],
    ...
    },
    {
        ...
        description:
        "Best when the prompt asks about tax remedies, protests, refund claims, assessment response, entered deadlines, or remedy evidence readiness.",
        required: [],
        aliases: ["tax remedies", "tax protest", "refund claim"],
        keywords: [
        /tax remed/i,
        /tax protest/i,
        /refund claim/i,
    ...
    },
    {
        ...
        description:
        "Best when the prompt asks about AIS incident response, CIA impact, containment, evidence readiness, or IT-audit escalation.",
        required: [],
        aliases: ["incident response", "security incident", "cia triad"],
        keywords: [
        /incident response/i,
        /security incident/i,
        /cia triad/i,
    ...
    },
    {
        ...
        description:
        "Best when the prompt asks for target cost, allowable cost, target profit, kaizen savings, or strategic cost gap.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Evaluate projected plus allowance misstatement against tolerable misstatement while keeping clearly trivial and qualitative pressure visible.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Plan audit materiality, performance materiality, clearly trivial thresholds, and misstatement cushion.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Reconcile taxable income, tax due, credits, payments, penalties, payable, and overpayment.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Score incompatible-duty conflicts and compensating review strength so AIS and IT-audit role-overlap cases stay structured.",
        required: [],
        aliases: [
    ...
    },
    {
        ...
        description:
            "Translate issue severity, override risk, stakeholder exposure, and oversight readiness into a clearer escalation tier.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Classify holder status, defenses, party liability, presentment, dishonor, and notice issues.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Map order-to-cash controls to assertions, walkthrough evidence, weak control gaps, and audit follow-up.",
        required: [],
    ...
    },
    {
        ...
        description:
            "Convert fraud triangle, management override, and evidence-quality signals into audit and governance response steps.",
        required: [],
