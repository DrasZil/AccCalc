...
const ROUTE_RULES: RouteRule[] = [
    ...
    {
        path: "/afar/installment-sales-review",
        label: "Installment Sales Gross Profit Review",
        category: "AFAR",
        patterns: [/\binstallment sales\b/i, /\bdeferred gross profit\b/i, /\brealized gross profit\b/i, /\bgross profit rate\b/i],
        bonus: [/\bcash collections?\b/i, /\brepossession\b/i, /\bcontract price\b/i],
        kindBoosts: { "word-problem": 5, "worked-solution": 4, "accounting-worksheet": 3 },
    },
    {
        path: "/audit/materiality-and-misstatement-planner",
        label: "Audit Materiality and Misstatement Planner",
        category: "Audit & Assurance",
        patterns: [/\bplanning materiality\b/i, /\bperformance materiality\b/i, /\bclearly trivial\b/i, /\buncorrected misstatement\b/i],
        bonus: [/\bbenchmark\b/i, /\btolerable misstatement\b/i, /\baudit risk\b/i],
        kindBoosts: { "word-problem": 4, "worked-solution": 4, "textbook-page": 3 },
    },
    {
        path: "/audit/going-concern-review",
        label: "Going Concern Review Workspace",
        category: "Audit & Assurance",
        patterns: [/\bgoing concern\b/i, /\bsubstantial doubt\b/i, /\bmanagement plans?\b/i, /\brecurring losses\b/i],
        bonus: [/\bliquidity\b/i, /\bdebt covenant\b/i, /\bsubsequent events?\b/i],
    ...
    },
    {
        ...
        category: "Taxation",
        patterns: [/\bincome tax payable\b/i, /\bwithholding credits?\b/i, /\bquarterly payments?\b/i, /\btax overpayment\b/i],
        bonus: [/\btax refund\b/i, /\bcreditable tax\b/i, /\bpenalties and interest\b/i],
        kindBoosts: { "word-problem": 4, "worked-solution": 3, "accounting-worksheet": 3 },
    },
    {
        path: "/tax/tax-remedy-timeline-review",
        label: "Tax Remedy Timeline Review",
        category: "Taxation",
        patterns: [/\btax remed(?:y|ies)\b/i, /\btax protest\b/i, /\brefund claim\b/i, /\bassessment\b/i],
        bonus: [/\bdeadline\b/i, /\bevidence\b/i, /\btaxpayer remedy\b/i],
    ...
    },
    {
        ...
        patterns: [/\brevenue cycle\b/i, /\border to cash\b/i, /\bsales order approval\b/i, /\binvoice sequence\b/i],
        bonus: [/\bcash application\b/i, /\bexception report\b/i, /\bcutoff\b/i],
        kindBoosts: { "textbook-page": 4, "notes-reference": 4, "word-problem": 3 },
    },
    {
        path: "/ais/incident-response-triage",
    ...
    },
    {
        ...
        label: "Fraud Risk Response Planner",
        category: "Governance & Ethics",
        patterns: [/\bfraud risk\b/i, /\bfraud triangle\b/i, /\bmanagement override\b/i, /\bprofessional skepticism\b/i],
        bonus: [/\bjournal entr(?:y|ies)\b/i, /\baudit committee\b/i, /\bgovernance\b/i],
        kindBoosts: { "textbook-page": 4, "notes-reference": 4, "word-problem": 3 },
    },
    {
        path: "/rfbt/negotiable-instruments-issue-spotter",
        label: "Negotiable Instruments Issue Spotter",
        category: "RFBT & Law",
        patterns: [/\bnegotiable instruments?\b/i, /\bholder in due course\b/i, /\bnotice of dishonor\b/i, /\bpresentment\b/i],
        bonus: [/\bpersonal defense\b/i, /\breal defense\b/i, /\bindorser\b/i],
        kindBoosts: { "textbook-page": 4, "notes-reference": 4, "word-problem": 3 },
    },
    {
