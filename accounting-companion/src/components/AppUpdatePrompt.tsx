...
export default function AppUpdatePrompt({
    ...
    return (
        <div className="fixed inset-x-3 bottom-[5.5rem] z-[108] md:bottom-6 md:left-auto md:right-6 md:w-[min(26rem,calc(100vw-3rem))]">
            <div className="app-panel-elevated rounded-[1.7rem] p-5 shadow-[var(--app-shadow-lg)]">
